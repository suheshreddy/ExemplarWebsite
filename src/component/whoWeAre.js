                ...
                <div className="lg:col-span-7 md:col-span-6">
                    <div className="lg:ms-5">
                        <div className="flex mb-4">
                            <span className="text-indigo-600 text-2xl font-bold mb-0"><CountUp className="counter-value text-6xl font-bold" start={1} end={75}></CountUp>+</span>
                        ...
                        <p className="text-slate-400 max-w-xl">We are a team of dedicated data professionals focused on transforming data into actionable insights. With expertise in analytics, strategy, and technology, we help businesses unlock their data’s full potential to drive informed decisions and achieve meaningful results.</p>
