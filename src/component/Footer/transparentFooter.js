            ...
            <div className="py-[60px] px-0">
              <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                <div className="lg:col-span-4 md:col-span-12">
                  <Link
                    to="/#"
                    className="text-[22px] focus:outline-none dark:hidden block"
                  >
                    <img src={logo_light} alt="" />
                  </Link>
                  <Link
                    to="/#"
                    className="text-[22px] focus:outline-none dark:block hidden"
                  >
                ...
                <div className="lg:col-span-2 md:col-span-4">
                  <h5 className="tracking-[1px] text-black dark:text-white font-semibold">
                    Company
                  </h5>
                  <ul className="list-none footer-list mt-6">
                    {footerCompany.map((data, index) => (
                      <li key={index} className={data.liClass}>
                        <Link
                          to={data.route}
                          className=" hover:text-gray-400 duration-500 ease-in-out inline-flex items-center"
                        >
        ...
        <div className="container relative text-center">
          <div className="grid md:grid-cols-2 items-center">
            <div className="md:text-start text-center">
              <p className="mb-0">
                © {new Date().getFullYear()} Exemplar Info. Design & Develop
