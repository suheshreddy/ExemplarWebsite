...
export default function PhotographyFooter() {
  return (
    <footer
      className="footer relative text-gray-400 dark:text-gray-400"
      style={{ background: `url(${footerimg}) top left` }}
    >
            ...
            <div className="py-[60px] px-0">
              <div className="grid grid-cols-1">
                ...
                <p className="mt-6 max-w-2xl">
                  As a Freelance Designer & Developer, I am here to make you
                  stand out in the digital world and my passion for design and
