              ...
              <ul className={`navigation-menu ${navClass} ${navJustify}`}>
                ...
                >
                  ...
                  <ul className="submenu">
                    <li
                      className={
                        manu === 'applications-integration' ? 'active' : ''
                      }
                    >
                      <Link
                        to="/what-we-do/applications-integration"
                    ...
                    <li
                      className={
                        manu === 'artificial-intelligence' ? 'active' : ''
                      }
                    >
                      <Link
                        to="/what-we-do/artificial-intelligence"
                        className="sub-menu-item"
                      >
                    ...
                    <li
                      className={manu === 'digital-workflows' ? 'active' : ''}
                    >
                      <Link
                        to="/what-we-do/digital-workflows"
                        className="sub-menu-item"
                      >
                        Digital Workflows
                      </Link>
                    ...
                    <li
                      className={
                        manu === 'infrastructure-cloud' ? 'active' : ''
                      }
                    >
                      <Link
                        to="/what-we-do/infrastructure-cloud"
                        className="sub-menu-item"
                      >
                    ...
                    <li
                      className={
                        manu === 'robotics-process-automation' ? 'active' : ''
                      }
                    >
                      <Link
                        to="/what-we-do/robotics-process-automation"
                        className="sub-menu-item"
                      >
                    ...
                    <li
                      className={manu === 'customer-experience' ? 'active' : ''}
                    >
                      <Link
                        to="/what-we-do/customer-experience"
                        className="sub-menu-item"
                      >
                        Customer Experience
                      </Link>
                ...
                >
                  ...
                  <ul className="submenu">
                    <li
                      className={
                        manu === 'banking-and-financial-services'
                          ? 'active'
                          : ''
                      }
                    >
                    ...
                    <li
                      className={
                        manu === 'life-sciences-healthcare' ? 'active' : ''
                      }
                    >
                      <Link
