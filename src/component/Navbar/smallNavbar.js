        ...
        <div className="container relative">
            ...
            <ul className="buy-button list-none space-x-1 mb-0">
                <li className="inline mb-0">
                    <Link className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600/5 hover:bg-indigo-600 border border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"><Icon.Settings className="size-4"></Icon.Settings></Link>
                </li>
            ...
            <div id="navigation" style={{ display: isMenu ? 'block' : 'none' }}>
                <ul className="navigation-menu justify-end" id="navmenu-nav">
                    ...
                    <li className="has-submenu">
                        <Link className="sub-menu-item" spy={true} smooth={true} duration={500} onClick={()=>setModal(!modal)}>Contact</Link>
                    </li>
                </ul>
            </div>
