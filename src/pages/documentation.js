          ...
          <div className="grid grid-cols-1 items-center gap-[30px]">
            <div>
              ...
              <p className="text-slate-400 text-base leading-8">
                <strong>Exemplar Info</strong> is a fully responsive, clean and
                modern high-converting React Js landing page template. It is a
                beautifully handcrafted, pixel perfect HTML5 landing page
                template based on the <b>React 18.X and Tailwind css v3.x.</b>.
                Exemplar Info is a Powerful React Js Multipurpose Landing Page
                Template. It is an excellent template for startup, cloud
                hosting, business, corporate, minimal portfolio single product
                (Smartwatch) , Saas, Social media marketing, Digital
                marketing/agency, Email Templates, Marketing, Agency, Careers
                and Jobs, Helpcenter, and much more.
              </p>
              <p className="text-slate-400 text-base leading-8 font-semibold mt-2">
                Dark & RTL version Available: We have added a RTL version in
                both Dark and Light versions.
              </p>
            </div>

            <div>
              <h4 className="text-3xl font-semibold mb-4">Setup React</h4>
              ...
              <p className="text-slate-400 text-base leading-8">
                ...
                which allows having complete automation for build flow. In case
                if you don't know Gulp then it's easy to use it. You can read it
                more about it{' '}
                <Link
                  to="https://nodejs.com/"
                  className="text-indigo-600 font-semibold mx-2"
                ...
                <li className="flex">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="text-slate-400 text-base leading-8">
                      ...
                      installed & running in your computer. If you already have
                      installed Node on your computer, you can skip this step if
                      your existing node version is greater than 16.
                    </p>
                  </div>
                </li>
              ...
              <p className="text-slate-400 text-base leading-8 mb-4">
              ...
              <div className="relative overflow-x-auto shadow dark:shadow-gray-800 rounded-md mt-6">
                <table className="w-full text-start text-slate-500 dark:text-slate-400">
                  <thead className="text-sm uppercase bg-slate-50 dark:bg-slate-800">
                    <tr>
                      <th className="w-2/3 px-6 py-3 text-start"> Command</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-6 py-4 border-t">
                        ...
                        <code className="text-red-600 mx-2">
                          node_modules
                        </code>{' '}
                        folder.
                      </td>
                    ...
                    <tr>
                      <td className="px-6 py-4 border-t">
                        <code className="text-red-600">npm start</code>
                      </td>
                      <td className="px-6 py-4 border-t">
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 border-t">
                        Generates a{' '}
                        <code className="text-red-600 mx-2">/dist</code>{' '}
