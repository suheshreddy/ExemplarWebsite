          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[30px]">
            {candidates.map((data, index) => {
              return (
                <div
                  key={index}
                  className="group relative p-6 rounded-md shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 transition duration-500 text-center"
                >
                  <div className="mt-8">
                    <img
                      src={data.image}
                      className="rounded-full shadow-md size-20 mx-auto block"
                      alt=""
                    />

                    <div className="mt-3">
                      <Link
                        to={`/page-job-candidate-detail/${data.id}`}
                        className="text-lg font-medium hover:text-indigo-600 transition duration-500 block"
                      >
                        {data.name}
                      </Link>
                  ...
                  <div className="flex items-center justify-around my-4">
                    ...
                    <span className="text-slate-400 flex items-center">
                      <PiCurrencyDollarSimpleLight className="text-indigo-600 me-2" />
                      3300/mo
                    </span>
                  </div>

                  <Link className="bg-gray-100 dark:bg-gray-800 text-slate-400 text-xs font-medium px-3 py-1 rounded-lg h-[24px] inline-block m-1">
                    PHP
                  </Link>
                  <Link className="bg-gray-100 dark:bg-gray-800 text-slate-400 text-xs font-medium px-3 py-1 rounded-lg h-[24px] inline-block m-1">
                    HTML
                  ...
                  <div className="mt-4">
                    <Link
                      ...
                      className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md w-full"
                    >
                      View Profile
                    </Link>
                  </div>
                  ...
                  <div className="absolute top-6 start-6">
                    <span className="bg-indigo-600/5 text-indigo-600 text-sm font-medium px-4 py-1 rounded-full h-[28px]">
                      Featured
                    </span>
                  </div>
