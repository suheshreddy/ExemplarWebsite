            ...
            <div className="lg:w-3/4 rounded-md shadow dark:shadow-gray-800 h-fit bg-white dark:bg-slate-900">
              <div className="p-6">
                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">2.2.0</span> - 11th
                  March 2024
                </h5>
                <ul className="list-none mb-10">
                  <li className="items-center text-slate-400 my-3 ms-2 text-lg">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Landing:
                  </li>
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated height & width classes to size-* as per
                    latest tailwindcss
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the tailwind.css file for if you direct
                    write your css classes in inline css
                  </li>

                  <li className="items-center text-slate-400 mb-3 mt-6 ms-2 text-lg">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Admin Dashboard:
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                ...
                <h5 className="text-xl font-bold">
                  Version <span className="text-emerald-600">2.1.0</span> - 9th
                  December 2023
                </h5>
                <ul className="list-none mb-10">
                  <li className="items-center text-slate-400 my-3 ms-2 text-lg">
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Add : Added new Classic Business (index-classic-business)
                    demo
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated data file for the repeted section and store
                    in common data file
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2 text-lg">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                ...
                <h5 className="text-xl font-bold mt-8">
                  Version <span className="text-emerald-600">2.0.0</span> - 19th
                  September 2023
                </h5>
                <ul className="list-none mb-10">
                  <li className="items-center text-slate-400 my-3 ms-2 text-lg">
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Remove: Removed all UNICONS icons and replaced or updated
                    REACT Icons
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                  ...
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the Dynamic Ecommerce Item detail page as
                    per the ID
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                    Update: Updated the Dynamic Real Estate detail page as per
                    the ID
                  </li>
                  <li className="items-center text-slate-400 my-3 ms-2">
                    <Icon.ArrowRightCircle className="size-4 me-2 text-indigo-600 inline"></Icon.ArrowRightCircle>
                ...
                <h5 className="text-xl font-bold mt-8">
                  Version <span className="text-emerald-600">1.0.0</span> - 1st
                  August 2023
                </h5>
                <ul className="list-none mb-10">
                  <li className="items-center text-slate-400 my-3 ms-2">
