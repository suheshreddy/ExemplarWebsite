...
export default function PortfolioMasonryTwo() {
  return (
    <>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <p className="text-slate-300 text-lg max-w-xl mx-auto">
              Showcase of Our Awesome Works in Two Columns
            </p>
          </div>
        </div>
      ...
      <PortfolioMasonryFilter
        shuffle={2}
        className="lg:w-3/4 mx-auto lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 mt-4 gap-[30px]"
