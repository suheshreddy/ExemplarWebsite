...
export default function PortfolioClassicFive() {
  return (
    <>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <p className="text-slate-300 text-lg max-w-xl mx-auto">
              Showcase of Our Awesome Works in Five Columns
            </p>
          </div>
        </div>
      ...
      <PortfolioClassicFilter
        containerfuild={true}
        className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-4 gap-[30px] px-4 "
      />
      <Footer />
    </>
  );
