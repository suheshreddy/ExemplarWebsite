          ...
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <ul className="list-none">
              <li className="inline font-semibold text-white/60 me-2">
                {' '}
                <span className="text-white">Client :</span> Calvin Carlo
              </li>
              <li className="inline font-semibold text-white/60">
                {' '}
                <span className="text-white">Date :</span> 23th May, 2022
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="container relative">
          <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            <div className="lg:col-span-8 md:col-span-7">
              <PortfolioDetailFilter shuffle={3} />
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 text-center">
            ...
            <div className="mt-6">
              <Link
                to="/contact-one"
                className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"
              >
