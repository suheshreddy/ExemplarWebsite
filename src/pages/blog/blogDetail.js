            ...
            <section className="relative table w-full py-32 lg:py-36 bg-[url('../../assets/images/blog/bg.jpg')] bg-center bg-no-repeat bg-cover">
                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8 text-center mt-10">
                        <h3 className="mb-3 text-3xl leading-normal font-medium text-white">{data.title} Case Study</h3>
                    ...
                    <div className="lg:col-span-2 md:col-span-1">
                        ...
                        <div className="lg:col-span-8 md:col-span-10">
                            <div className="p-6 rounded-md shadow dark:shadow-gray-800">
                                ...
                                <div className="mt-6">
                                    {data && data?.content.map((item,index) => <p key={index + "1"} className={item.class}>{item.text}</p>)}
                                </div>
                            </div>
