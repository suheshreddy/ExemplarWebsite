...
import imageP from '../../assets/images/blog/03.jpg';
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-6 order-1 md:order-2">
                            <div className="p-6 rounded-md shadow dark:shadow-gray-800">
                                ...
                                <img src={imageP} className="rounded-md" alt="" />
                        ...
                        <BlogUserDetail className={"lg:col-span-4 md:col-span-6 order-2 md:order-1"} />
                    </div>
                </div>
