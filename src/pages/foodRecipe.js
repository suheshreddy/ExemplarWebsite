          ...
          <div className="md:flex">
            <div className="relative lg:w-2/3 w-full -mt-32">
              <div className="px-6 py-12 bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800 text-center">
                <Link
                  to="#"
                  className="bg-indigo-600/10 text-indigo-600 font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5"
                >
                  Food & Recipes
                </Link>
                <h5 className="font-semibold text-2xl mt-5">
                  {data?.title
                    ? data?.title
                    : 'Recipes Creamy Garlic Parmesan Chicken Salad'}
                </h5>
                ...
                <div className="flex items-center justify-center mt-5">
                  <div className="flex items-center mx-2">
                    <img
                      src={imageP}
                      className="size-7 rounded-full shadow-md dark:shadow-gray-800"
                      alt=""
                    />
                    <Link
                      to="#"
                      className="font-medium text-slate-400 block ms-2"
                    >
                      Cristina Romsey
                    </Link>
                  </div>

                  <span className="text-slate-400 flex items-center mx-2">
                    <MdOutlineCalendarMonth width={18} className="me-1" />{' '}
                    {data?.date ? data?.date : '14th July 2022'}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            <div className="lg:col-span-8 md:col-span-6">
              <div>
                <Link
                  to="#"
                  className="bg-indigo-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5 me-1"
                >
                  Food
                </Link>
                <Link
                ...
                <p className="text-slate-400 mb-4 mt-5">
                  Sunt in culpa qui officia deserunt mollit anim id est laborum.
                  Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                  accusantium doloremque laudantium, totam rem aperiam, eaque
                  ipsa quae ab illo inventore veritatis et quasi architecto
                  beatae eaque ipsa quae ab illo inventore veritatis et quasi
                  architecto beatae.
                </p>
                    ...
                    <div className="group relative">
                      <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                        ...
                        <div className="absolute top-0 start-0 pt-3 ps-3">
                          <Link
                            to="#"
                            className="bg-indigo-600 text-white text-xs font-semibold px-2.5 py-0.5 rounded w-fit mx-auto h-5"
                          >
                            {item.tag}
                          </Link>
                        </div>
          ...
          <div className="tiny-twelve-item">
            ...
            {lightBox && (
              <Lightbox
                ...
                prevSrc={
                  foodImage[
                    (currentImageIndex + foodImage.length - 1) %
                      foodImage.length
                  ]
                }
