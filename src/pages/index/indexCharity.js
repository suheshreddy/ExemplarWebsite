                    ...
                    <div className="mb-5">
                      ...
                      <div className="relative mt-2">
                        <span
                          ...
                          id="basic-addon1"
                        >
                          <BiDollarCircle className="size-5" />
                        </span>
                        <input
                          type="number"
          ...
          <div className="relative grid md:grid-cols-4 grid-cols-2 items-center gap-[30px]">
            <div className="counter-box text-center">
              <h1 className="text-4xl font-bold mb-4 text-white">
                <CountUp className="counter-value" start={1} end={100} />M
              </h1>
            ...
            <div className="counter-box text-center">
              <h1 className="text-4xl font-bold mb-4 text-white">
                <CountUp className="counter-value" start={2} end={152} />M
              </h1>
              <h5 className="counter-head text-xs font-semibold text-white">
            ...
            <div className="counter-box text-center">
              <h1 className="text-4xl font-bold mb-4 text-white">
                $<CountUp className="counter-value" start={0} end={1500} />M
              </h1>
              <h5 className="counter-head text-xs font-semibold text-white">
            ...
            <div className="counter-box text-center">
              <h1 className="text-4xl font-bold mb-4 text-white">
                <CountUp className="counter-value" start={0} end={29} />M
              </h1>
              <h5 className="counter-head text-xs font-semibold text-white">
