      ...
      <section className="relative table w-full py-36 lg:py-52 bg-[url('../../assets/images/hosting/bg-hosting.jpg')] bg-center bg-no-repeat bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h5 className="text-lg text-white font-medium mb-3">
                        ...
                        <div className="tiny-slide" key={index}>
                          <Link className="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                            <span className="p-4 block bg-white dark:bg-slate-900 text-center">
                              <img
                                src={item.image}
                                className="rounded-full shadow-md mx-auto size-16 mb-3"
                                alt=""
                              />

                              <span className="text-xl font-medium group-hover:text-indigo-600 transition-all duration-500 ease-in-out">
                                {item.extension}
                              </span>
                            ...
                            <span
                              className={`p-4 block text-center ${item.background}`}
                            >
                              <span className="text-white font-medium uppercase block">
                                {item.sale}
                              </span>
                              <span className="flex justify-center mt-2">
                                ...
                                <span className="text-lg text-white font-semibold mx-1">
                                  {item.price}
                                </span>
                                <span className="text-base text-white/70 font-semibold self-end">
                                  {item.time}
                                </span>
                              </span>
                            </span>
          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
            ...
            <div className="lg:col-span-6 md:order-1 order-2">
              ...
              <p className="text-slate-400 max-w-xl">
                ...
                one, you can take a component from the Application theme and use
                it in the Website.
              </p>
            ...
            <div className="relative z-2 transition-all duration-500 ease-in-out sm:-mt-[200px] -mt-[140px] m-0">
              <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                <div className="group relative rounded-md overflow-hidden hover:shadow dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center transition-all duration-500 ease-in-out h-fit">
                  <div className="p-6 py-8 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <p className="text-slate-400 mt-4">
                      We offers a{' '}
                      <b className="text-black dark:text-white">free month</b>{' '}
                      of service for new customers.
                    </p>
                  </div>
                  ...
                  <div className="p-6 hosting-price">
                    ...
                    <div id="StarterContent" className="mt-6">
                      {isOpenTab === 0 ? (
                        <div className="flex justify-center">
                          ...
                          <span className="text-3xl font-semibold mx-1">
                            3.99
                          </span>
                          <span className="text-sm text-slate-400 font-semibold self-end">
                            /month
                          </span>
                        </div>
                      ) : (
                    ...
                    <div className="mt-6">
                      <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md">
                        Add Cart
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="py-3 px-2 bg-gray-50 dark:bg-slate-800">
                    <p className="text-slate-400 mb-0">
                      Great Start For A{' '}
                      <b className="text-black dark:text-white">Single</b> Site.
                    </p>
                  </div>

                  <div className="p-6 border-b border-gray-100 dark:border-gray-700 text-start">
                    <ul className="list-none space-x-1">
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-emerald-600"></i>
                        <b className="text-black dark:text-white">1</b> Website
                      </li>
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-amber-500"></i>
                        <b className="text-black dark:text-white">1</b> Email
                        Account
                      </li>
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-amber-500"></i>
                ...
                <div className="group relative rounded-md overflow-hidden hover:shadow dark:shadow-gray-800 hover:shadow-indigo-600 border-[3px] border-indigo-600 bg-white dark:bg-slate-900 text-center transition-all duration-500 ease-in-out">
                  ...
                  <div className="p-6 hosting-price">
                    <ul
                      className="inline-block flex-wrap justify-center text-center p-1 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-full"
                      id="myTabtwo"
                  ...
                  <div className="py-3 px-2 bg-gray-50 dark:bg-slate-800">
                    <p className="text-slate-400 mb-0">
                      More Sites &{' '}
                      <b className="text-black dark:text-white">2X</b>{' '}
                      Resources.
                    </p>
                  </div>
                  ...
                  <div className="p-6 border-b border-gray-100 dark:border-gray-700 text-start">
                    <ul className="list-none space-x-1">
                      ...
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-amber-400"></i>
                        <b className="text-black dark:text-white">
                          2X Processing
                        </b>{' '}
                        Power &amp; Memory
                ...
                <div className="group relative rounded-md overflow-hidden hover:shadow dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center transition-all duration-500 ease-in-out h-fit">
                  ...
                  <div className="p-6 hosting-price">
                    <ul
                      className="inline-block flex-wrap justify-center text-center p-1 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-full"
                      id="myTabthree"
                      data-tabs-toggle="#BusinessContent"
                      role="tablist"
                    >
                      <li className="inline-block">
                        <button
                          onClick={() => handleTabClick2(0)}
                          className={`${
                            isOpenTab2 === 0
                              ? 'text-white bg-indigo-600 hover:text-white'
                              : ''
                  ...
                  <div className="py-3 px-2 bg-gray-50 dark:bg-slate-800">
                    <p className="text-slate-400 mb-0">
                      Boost Servers{' '}
                      <b className="text-black dark:text-white">+ More Power</b>
                    </p>
                  </div>
                  ...
                  <div className="p-6 border-b border-gray-100 dark:border-gray-700 text-start">
                    <ul className="list-none space-x-1">
                      ...
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-emerald-600"></i>
                        <b className="text-black dark:text-white">Daily</b>{' '}
                        Backups
                      </li>
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-emerald-600"></i>
                        <b className="text-black dark:text-white">Free</b> SSL
                        Certificate
                      </li>
                      <li className="text-slate-400 my-1">
                        <i className="mdi mdi-check me-2 text-emerald-600"></i>
