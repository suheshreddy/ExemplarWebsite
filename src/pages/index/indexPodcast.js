          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="lg:col-span-7">
              <div className="me-6">
                ...
                <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-[54px] my-5 text-black dark:text-white">
                  Find and Listen on <br /> your{' '}
                  <span className="text-indigo-600">favorite podcast</span>
                </h4>
                ...
                <div className="mt-8">
                  <Link
                    ...
                    className="lightbox py-1.5 ps-5 pe-2 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"
                  >
                    Listen Now{' '}
                    <span className="size-8 inline-flex items-center justify-center rounded-full bg-white border border-white text-indigo-600 ms-3">
            ...
            <div className="lg:col-span-5 relative">
              <div className="grid grid-cols-2 items-center md:gap-4 gap-3">
                <div className="md:space-y-4 space-y-3">
                  <img
                    src={banner1}
                    className="border-[3px] border-gray-100 dark:border-gray-800 rounded-lg"
                    alt=""
                  />
                  <img
                    src={banner2}
              ...
              <div className="absolute top-1/2 -translate-y-1/2 -start-4 py-2 px-3 flex items-center rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-fit my-3">
                <BiMicrophone className="text-indigo-600 text-xl align-middle" />{' '}
                <span className="font-semibold ms-1">Amazing Conversation</span>
              </div>
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                <h4 className="mb-6 md:text-4xl text-3xl lg:leading-normal leading-normal font-bold">
                  Listen podcast anytime <br /> and anyware you want
                </h4>
                <p className="text-slate-400 max-w-xl mb-2">
                  Exemplar Info Homes developed a platform for the Real Estate
                  marketplace that allows buyers and sellers to easily execute a
                  transaction on their own.
                </p>
                <p className="text-slate-400 max-w-xl">
                  The platform drives efficiency, cost transparency and control
                  into the hands of the consumers. Exemplar Info Homes is Real
                  Estate Redefined.
                </p>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid md:grid-cols-12 grid-cols-1 items-center">
            <div className="md:col-span-6">
              ...
              <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                All Podcasts from <br /> Audio & Video
              </h3>
            </div>
                      ...
                      <div className="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden m-3">
                        <div className="relative">
                          ...
                          <Link
                            to="#!"
                            onClick={() => setOpen(true)}
                            className="lightbox size-8 inline-flex items-center justify-center rounded-full bg-white border border-white text-indigo-600 absolute top-3 end-3"
                          >
                            <i className="mdi mdi-play"></i>
                          </Link>
                          ...
                          <div className="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                            <div className="pb-4 ps-4 flex items-center">
                              <img
                                src={clientImage}
                                className="size-10 rounded-full shadow-md dark:shadow-gray-800 mx-auto"
                                alt=""
                              />
                              <div className="ms-3">
                                <Link
                        ...
                        <div className="content p-6">
                          <audio
                            controls
                            className="block w-full max-w-md mx-auto mb-3"
                          >
                            <source
                          ...
                          <div className="mt-4">
                            ...
                            >
                              Watch Now{' '}
                              <FaArrowRight className="ms-1 text-[10px]" />
                            </Link>
                          </div>
                        </div>
                      </div>
            ...
            <div className="group border-b-[3px] dark:border-gray-700 p-6 py-8 hover:border-indigo-600 dark:hover:border-indigo-600 duration-500 hover:scale-105 relative overflow-hidden shadow dark:shadow-gray-800 rounded-md bg-gray-50 dark:bg-slate-800 hover:bg-white dark:hover:bg-slate-900 h-fit">
              ...
              <ul className="list-none text-slate-400">
                <li className="mb-1 flex items-center ms-0">
                  <BsCheckCircle className=" text-indigo-600 text-xl me-2" />{' '}
                  Full Access
                </li>
                <li className="mb-1 flex items-center ms-0">
                  <BsCheckCircle className=" text-indigo-600 text-xl me-2" />{' '}
