...
export default function IndexLandingFive() {
  ...
  return (
    <>
      ...
      <section
        className="relative py-40 lg:h-screen flex justify-center items-center bg-indigo-600/10 overflow-hidden"
        id="home"
      >
            ...
            <div className="lg:col-span-7">
              <div className="md:text-start text-center">
                <h1 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-6">
                  Resources for{' '}
                  <span className="text-indigo-600">makers &</span> <br />{' '}
                  <span className="text-indigo-600">Creative</span> to learn &
                  grow
                </h1>
                ...
                <span className="text-slate-400 font-medium">
                  Looking for help?{' '}
                  <Link className="text-indigo-600">Get in touch with us</Link>
                </span>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                <div className="relative">
                  <img
                    src={avatar}
                    className="lg:w-[400px] w-[280px] rounded-lg shadow dark:shadow-gray-800"
                    alt=""
                  />
                ...
                <div className="absolute -end-5 -bottom-16">
                  <img
                    src={ab2}
                    className="lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900 rounded-lg shadow dark:shadow-gray-800"
                    alt=""
                  />
                </div>
              </div>
