            ...
            <div className="flex items-center justify-between">
              <ul className="list-none mb-0">
                <li className="inline mb-0">
                  ...
                  >
                    <FiMail className="size-4 me-1 text-indigo-600" />{' '}
                    contact@example.com
                  </Link>
                </li>
                <li className="inline mb-0 ms-3">
                  <Link
                    ...
                    className="text-slate-400 hover:text-indigo-600 inline-flex items-center"
                  >
                    <FiPhone className="size-4 me-1 text-indigo-600" /> +152
                    534-468-854
                  </Link>
                </li>
              </ul>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6">
                ...
                <div className="relative flex justify-end">
                  ...
                  <div className="absolute top-0 translate-y-2/4 start-0 text-center">
                    <Link
                      ...
                      className="lightbox size-20 rounded-full shadow-lg shadow-slate-100 dark:shadow-slate-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600"
                    >
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-5">
                ...
                <Link
                  to=""
                  className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded"
                >
                  Get Started
                </Link>
              </div>
          ...
          <div className="relative grid md:grid-cols-3 grid-cols-1 items-center mt-8 gap-[30px] z-1">
            <div className="counter-box text-center">
              <h1 className="lg:text-5xl text-4xl font-bold mb-2">
                <CountUp className="counter-value" start={1} end={1548} />+
              </h1>
            ...
            <div className="counter-box text-center">
              <h1 className="lg:text-5xl text-4xl font-bold mb-2">
                <CountUp className="counter-value" start={1} end={25} />+
              </h1>
              <h5 className="counter-head text-lg font-medium">
                Daily data input
              </h5>
            ...
            <div className="counter-box text-center">
              <h1 className="lg:text-5xl text-4xl font-bold mb-2">
                <CountUp className="counter-value" start={1} end={9} />+
              </h1>
              <h5 className="counter-head text-lg font-medium">
                Years Experience
              </h5>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="md:col-span-6 order-2 md:order-1">
              <div className="lg:me-5">
                ...
                >
                  <PiNotepadBold className="me-1" /> Get Started
                </Link>
              </div>
            </div>
          </div>
