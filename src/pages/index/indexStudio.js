            ...
            <div className="md:col-span-7">
              <div className="md:me-6">
                <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5">
                  Bigger, Bolder
                  <br /> <span className="text-indigo-600">& Better</span>
                </h4>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
            <div className="lg:col-span-8 md:col-span-6 md:text-start text-center">
              <h3 className="md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                We create world-className <br /> web design, and <br />{' '}
                branding.
              </h3>
            </div>
              ...
              <div className="grid lg:grid-cols-1 grid-cols-2 sticky top-20">
                <div className="counter-box relative md:text-start text-center">
                  <h1 className="font-bold text-3xl text-indigo-600">
                    <CountUp className="counter-value" end={11} start={3} />+
                  </h1>
                  <span className="counter-head font-medium h6">
                ...
                <div className="counter-box relative md:text-start text-center lg:mt-6">
                  <h1 className="font-bold text-3xl text-indigo-600">
                    <CountUp className="counter-value" end={5} start={1} />
                  </h1>
                  <span className="counter-head font-medium h6">
              ...
              <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                {studioAbout.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="p-6 rounded-lg shadow dark:shadow-gray-800 bg-white dark:bg-slate-900"
                    >
                      <div className="size-16 bg-indigo-600/5 border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800">
