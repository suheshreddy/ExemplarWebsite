...
import { FiHexagon, FiChevronRight } from '../../assets/icons/icons';
...
export default function LandingSix() {
  ...
  return (
    <>
      <Navbar />
      <section
        className="relative md:pt-44 py-36 bg-slate-50 dark:bg-slate-800"
        id="home"
      >
        <div className="container relative">
          <div className="grid grid-cols-1 justify-center text-center">
            <div className="">
              <h1 className="font-bold lg:leading-normal leading-normal tracking-wide text-4xl lg:text-5xl capitalize mb-5">
              ...
              <div className="subcribe-form mt-6 mb-3">
                <form className="relative max-w-xl mx-auto">
                  <input
                    ...
                    id="emailid"
                    name="email"
                    className="py-4 pe-40 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/60 dark:bg-slate-900/60 shadow dark:shadow-gray-800"
                    placeholder="yourname@domain.com"
                  />
                  <button
                    type="submit"
                    className="absolute top-[2px] end-[3px] h-[46px] py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"
                  >
                    Subscribe Now
                  </button>
                </form>
          ...
          <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {aboutFive.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center"
                >
                  ...
                  <div class="mt-6">
                    <Link
                      to=""
                      class="text-lg font-medium group-hover:text-white duration-500"
                    >
                      {item.title}
                    </Link>
            ...
            <div class="relative z-1">
              <div class="grid lg:grid-cols-12 grid-cols-1 md:text-start text-center justify-center">
                <div class="lg:col-start-2 lg:col-span-10">
                  <div class="relative">
                    <img src={Cta} class="rounded-md shadow-lg" alt="" />
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 items-center">
                      ...
                      <div class="mt-8">
                        <div class="section-title text-md-start">
                          ...
                          >
                            Read More{' '}
                            <FiChevronRight class="align-middle"></FiChevronRight>
                          </Link>
                        </div>
                      </div>
                    </div>
