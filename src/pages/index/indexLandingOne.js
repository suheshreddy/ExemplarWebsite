        ...
        <div className="container relative z-2">
          <div className="grid grid-cols-1 md:mt-44 mt-32 text-center">
            <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5">
              Solve Problem With on Integrated <br /> Marketing Agency
            </h4>
            ...
            <div className="mt-6">
              <div className="subcribe-form mt-6 mb-3">
                <form className="relative mx-auto max-w-xl">
                  ...
                  >
                    Get Started <FaArrowRight className="ms-2 text-[10px]" />
                  </button>
                </form>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 pb-8 items-center">
            <div className="md:col-span-6 md:text-start text-center">
              <h3 className="md:mb-0 mb-6 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                Why Everyone Loves <br /> Exemplar Info
              </h3>
            </div>
        ...
        <div className="container relative">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {priceData.map((item, index) => {
              return (
                <div
                  className="group rounded-md shadow bg-white dark:bg-slate-900"
                  key={index}
                >
                  <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h6 className="font-bold mb-3 text-lg uppercase">
                      {item.title}
                    </h6>
                  ...
                  <div className="p-6">
                    ...
                    <ul className="list-none text-slate-400">
                      <li className="mb-1 flex">
                        <span className="text-emerald-600 h5">
                          <BsCheckCircle className="text-base me-2" />
                        </span>{' '}
                        1 Domains
                      </li>
                      <li className="mb-1 flex">
                      ...
                      <li className="mb-1 flex">
                        <span className="text-red-600 h5">
                          <LiaTimesCircleSolid className="text-lg me-2" />
                        </span>{' '}
                        Unlimited bandwidth{' '}
                      </li>
                    </ul>
          ...
          <div className="md:flex justify-center mt-4">
            <div className="text-center">
              <p className="text-slate-400">
                Note: <span className="text-red-600 fs-5">*</span>No credit card
                required
              </p>
            </div>
          </div>
