...
export default function IndexLandingFour() {
  ...
  return (
    <>
      <Navbar />
      <section
        className="relative table w-full py-36 lg:py-44 bg-gray-50 dark:bg-slate-800 bg-[url('../../assets/images/bg4.png')] bg-bottom bg-cover"
        id="home"
      >
          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-2 mt-10 items-center gap-[30px]">
            <div className="lg:col-span-7">
              ...
              <div className="relative mt-10">
                <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full me-1">
                  Get Started
                </Link>
                <Link
                  to="#"
                  ...
                  data-type="youtube"
                  data-id="S_CGed6E610"
                  className="size-12 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full lightbox"
                >
                  <i className="mdi mdi-play text-xl align-middle"></i>
                </Link>
                <small className="text-sm uppercase align-middle font-bold ms-2">
                  Watch Now
                </small>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                ...
                <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-3">
          ...
          <div className="grid grid-cols-1 justify-center">
            <div className="mt-6 text-center">
              <Link className="relative inline-flex items-center font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500">
                See More <MdKeyboardArrowRight className="text-xl ms-1" />
              </Link>
            </div>
          </div>
        </div>
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center">
                      ...
                      <div className="mt-8">
                        <div className="section-title text-md-start">
                          ...
                          <Link className="text-white inline-flex items-center">
                            Read More{' '}
