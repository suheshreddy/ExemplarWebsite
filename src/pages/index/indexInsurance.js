...
export default function IndexInsurance() {
  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="md:col-span-7">
              <div className="md:me-6">
                <div className="bg-white dark:bg-slate-900 text-slate-400 py-2 px-4 inline-flex items-center font-medium rounded-full shadow dark:shadow-gray-800">
                  <span className="bg-indigo-600 text-white text-[12px] font-bold px-2.5 py-0 rounded-full me-2">
                    Exemplar Info
                  </span>{' '}
                  Get an insurance
                </div>
                <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 mt-4">
                  Insurance makes <br /> your life your better
                </h4>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 items-end">
            <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
              <span className="text-indigo-600">Get the right protection</span>{' '}
              <br /> and move forward
            </h3>
            ...
            <div className="order-2 lg:order-1 lg:mt-0 mt-8">
              <div className="lg:me-6 text-center lg:text-start">
                <h3 className="mb-4 md:text-4xl text-3xl lg:leading-normal leading-normal text-white font-semibold">
                  Compare insurance packages <br /> and obtain the best offer
                </h3>

                <p className="text-white/80 max-w-xl mx-auto lg:ms-auto">
                  Start working with Exemplar Info that can provide everything
                ...
                <div className="mt-6">
                  <Link
                    to="#"
                    className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-slate-100 hover:bg-slate-200 border-slate-100 hover:border-slate-200 text-indigo-600 rounded-md me-2 mt-2"
                  >
                    Get a custom plan
                  </Link>
                </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="grid grid-cols-2 gap-[30px]">
                <div className="counter-box text-center">
                  <h1 className="lg:text-5xl text-4xl font-bold mb-2 text-white">
                    <CountUp className="counter-value" end={145} start={101} />M
                  </h1>
                ...
                <div className="counter-box text-center">
                  <h1 className="lg:text-5xl text-4xl font-bold mb-2 text-white">
                    <CountUp className="counter-value" end={99} start={2} />%
                  </h1>
                  <h5 className="text-white text-xl font-medium">
      ...
      <section className="relative md:py-24 py-16">
        <div className="container relative">
          <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            <div className="relative">
              <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                <span className="text-indigo-600">Insurance</span> for your{' '}
                <br /> everyday needs
              </h3>
              <p className="text-slate-400 max-w-xl">
              ...
              <div className="sticky top-20">
                ...
                >
                  <li role="presentation">
                    <button
                      className={`${
                        isOpenTab === 0 ? 'text-white bg-indigo-600' : ''
                  ...
                  <li role="presentation">
                    <button
                      ...
                      className={`${
                        isOpenTab === 1 ? 'text-white bg-indigo-600' : ''
                  ...
                  <li role="presentation">
                    <button
                      ...
                      className={`${
                        isOpenTab === 2 ? 'text-white bg-indigo-600' : ''
                      } px-4 py-2 text-base font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out`}
                      id="settings-tab"
                  ...
                  <li role="presentation">
                    <button
                      ...
                      className={`${
                        isOpenTab === 3 ? 'text-white bg-indigo-600' : ''
                      } px-4 py-2 text-base font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out`}
                      id="contacts-tab"
            ...
            <div className="lg:col-span-8 md:col-span-7">
              ...
              >
                {insuranceTab.map((item, index) => (
                  <div
                    className={`${isOpenTab === index ? '' : 'hidden'}`}
                    id="profile"
                    role="tabpanel"
      ...
      <section
        className="py-20 w-full relative bg-[url('../../assets/images/insurance/bg.jpg')] bg-center bg-no-repeat bg-cover jarallax"
        data-jarallax
        data-speed="0.5"
      >
        <div className="container relative">
