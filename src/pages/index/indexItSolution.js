                    ...
                    <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                        <div className="lg:col-span-7">
                            <div className="md:me-6 md:mb-20">
                                ...
                                <h4 className="font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-white">Unleash the power of <br /> Data</h4>
                                <p className="text-white/60 text-lg max-w-xl">Unlock the full potential of your data with our expert consulting services. We provide tailored analytics solutions and strategic insights to drive your business forward. Transform data into actionable strategies and stay ahead in today's competitive landscape.</p>
            ...
            <section className="relative md:py-24 py-16">
                <div className="container relative md:mb-24 mb-16">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        ...
                        <p className="text-slate-400 max-w-2xl mx-auto">We specialize in turning data into powerful business assets. Our comprehensive data consulting services include strategic data analysis, advanced analytics, data visualization, and robust data engineering. We work closely with our clients to understand their unique challenges and objectives, delivering tailored solutions that drive growth and efficiency. From building data-driven strategies to implementing cutting-edge technologies, we empower businesses to make informed decisions and achieve their goals.</p>
                    </div>
