...
import development from '../../assets/images/illustrator/development.svg';
...
export default function IndexPhoneNumber() {
  return (
    <>
      <Navbar />
      <section className="relative table w-full py-36 lg:py-44 bg-gray-50 dark:bg-slate-800">
            ...
            <div className="md:col-span-7 md:order-2 order-1">
              <div className="ms-6">
                <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">
                  Stand Out With a Custom{' '}
                  <span className="text-indigo-600">Phone Number</span>
                </h4>
                <p className="text-slate-400 text-lg max-w-xl">
                  Exemplar Info is the largest provider of custom phone numbers
                  since 2020
                </p>
        ...
        <div className="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
          <ul className="tracking-[0.5px] mb-0 inline-flex space-x-1">
            ...
            <li
              className="inline  uppercase text-[13px] font-bold duration-500 ease-in-out text-indigo-600"
              aria-current="page"
            >
              Phone Number
            </li>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
              Why People Choose Exemplar Info for Custom Numbers
            </h3>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {mobileNumber.map((data, index) => {
              return (
                <div
                  key={index}
                  className="group p-4 text-center rounded-lg shadow hover:shadow-lg dark:shadow-gray-800 transition duration-500"
                >
                  <Link className="hover:text-indigo-600 text-xl font-semibold">
                    {data.number}
                  </Link>
                  ...
                  <div className="mt-3 flex items-center justify-center">
                    ...
                    <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full ms-3">
                      Buy Now
                    </Link>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 mt-8">
            <div className="md:col-span-12 text-center">
              <Link className="relative inline-flex items-center font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:transition-all after:duration-500 text-slate-400 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">
                See More Numbers <FaArrowRight className="ms-2 text-[10px]" />
              </Link>
            </div>
          </div>
        </div>
