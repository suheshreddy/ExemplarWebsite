...
export default function IndexFurniture() {
  ...
  const handleMovePrev = () => {
    setCurrentImageIndex(
      (prevIndex) =>
        (prevIndex + furnitureImage.length - 1) % furnitureImage.length
    );
  };

  const handleMoveNext = () => {
    setCurrentImageIndex(
      (prevIndex) => (prevIndex + 1) % furnitureImage.length
    );
  };
      ...
      >
        <div className="overflow-hidden relative h-screen inset-0">
          ...
          >
            <SwiperSlide>
              <div
                className="flex items-center justify-center transition-all h-screen duration-700 bg-[url('../../assets/images/furniture/bg01.jpg')] bg-center bg-no-repeat bg-cover"
              ...
              >
                <div className="absolute md:end-0 md:start-auto bottom-0 w-full lg:w-[700px] md:w-[500px] h-fit bg-white dark:bg-slate-900 md:p-20 p-10">
                  <h5 className="uppercase font-bold mb-4 text-sm">
                    New Arrivals
                  </h5>
                  <h1 className="font-bold dark:text-white lg:leading-normal leading-normal text-3xl lg:text-5xl">
                    Modern <br /> Furniture
                  </h1>
                  ...
                  <div className="mt-8">
                    ...
                    >
                      Shop Now <FaArrowRight className="ms-2 text-[10px]" />
                    </Link>
                  </div>
                </div>
              </div>
            ...
            <SwiperSlide>
              <div
                className="flex items-center justify-center transition-all h-screen duration-700 bg-[url('../../assets/images/furniture/bg02.jpg')] bg-center bg-no-repeat bg-cover"
                data-carousel-item=""
              >
                <div className="absolute md:end-0 md:start-auto bottom-0 w-full lg:w-[700px] md:w-[500px] h-fit bg-white dark:bg-slate-900 md:p-20 p-10">
                  <h5 className="uppercase font-bold mb-4 text-sm">
            ...
            <SwiperSlide>
              <div
                className="flex items-center justify-center transition-all h-screen duration-700 bg-[url('../../assets/images/furniture/bg03.jpg')] bg-center bg-no-repeat bg-cover"
                data-carousel-item=""
              >
                <div className="absolute md:end-0 md:start-auto bottom-0 w-full lg:w-[700px] md:w-[500px] h-fit bg-white dark:bg-slate-900 md:p-20 p-10">
                  <h5 className="uppercase font-bold mb-4 text-sm">
          ...
          <div
            className="flex items-center justify-center transition-all duration-700 bg-[url('../../assets/images/furniture/bg02.jpg')] bg-center bg-no-repeat bg-cover"
            data-carousel-item=""
          >
            <div className="absolute md:end-0 md:start-auto bottom-0 w-full lg:w-[700px] md:w-[500px] h-fit bg-white dark:bg-slate-900 md:p-20 p-10">
              <h5 className="uppercase font-bold mb-4 text-sm">New Arrivals</h5>
          ...
          <div
            className="flex items-center justify-center transition-all duration-700 bg-[url('../../assets/images/furniture/bg03.jpg')] bg-center bg-no-repeat bg-cover"
            data-carousel-item=""
          >
            <div className="absolute md:end-0 md:start-auto bottom-0 w-full lg:w-[700px] md:w-[500px] h-fit bg-white dark:bg-slate-900 md:p-20 p-10">
              <h5 className="uppercase font-bold mb-4 text-sm">New Arrivals</h5>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
            <div className="group relative overflow-hidden shadow dark:shadow-gray-800">
              ...
              <div className="absolute top-1/2 -translate-y-1/2 p-6">
                <Link
                  to="#"
                  className="font-semibold text-2xl text-slate-950 hover:text-indigo-600 transition-all duration-500"
                >
                  Sofa Set for House
                </Link>

                <p className="mt-2 text-slate-950 font-medium">
                  Dispatched within a week, from $125
                </p>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
            <div className="lg:col-span-8 md:col-span-6 md:text-start text-center">
              ...
              <p className="text-slate-400 max-w-xl">
                Please check the below our latest or popular items
              </p>
            </div>
                ...
                <div className="group" key={index}>
                  <div className="relative overflow-hidden shadow dark:shadow-gray-800">
                    ...
                    <div className="absolute -bottom-20 group-hover:bottom-3 start-3 end-3 transition-all duration-500">
                      <Link
                        to="#"
                        className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-slate-900 border-slate-900 text-white w-full"
                      >
                        Add to Cart
                      </Link>
                    </div>
                    ...
                    <span className="absolute top-[10px] end-4 opacity-0 group-hover:opacity-100 transition-all duration-500">
                      <Link
                        to="#"
                        className="text-slate-900 focus:text-red-600 dark:focus:text-red-600 hover:text-red-600 dark:hover:text-red-600 text-2xl"
                      >
        ...
        <div className="container relative">
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px]">
            {featuredCollection.map((item, index) => {
              return (
                <div
                  className="group relative overflow-hidden shadow dark:shadow-gray-800"
                  key={index}
                >
                  <img
                    src={item.image}
        ...
        <div className="grid grid-cols-1 relative">
          ...
          {lightBox && (
            <Lightbox
              ...
              prevSrc={
                furnitureImage[
                  (currentImageIndex + furnitureImage.length - 1) %
                    furnitureImage.length
                ]
              }
              nextSrc={
                furnitureImage[(currentImageIndex + 1) % furnitureImage.length]
              }
