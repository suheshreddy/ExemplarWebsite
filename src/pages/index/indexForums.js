        ...
        <div className="container relative">
          <div className="grid grid-cols-1 mt-10 text-center">
            <h3 className="font-bold uppercase leading-normal text-4xl mb-5">
              Welcome to the Exemplar Info Forum
            </h3>
            ...
            <div className="subcribe-form mt-6">
              <form className="relative max-w-xl mx-auto">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center absolute top-[2px] end-[3px] size-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"
                >
            ...
            <div className="relative -mt-12 rounded-md shadow dark:shadow-gray-800 overflow-hidden bg-white dark:bg-slate-900">
              <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                <div className="md:col-span-6">
                  <div
                    className="w-full py-52 bg-slate-400 bg-[url('../../assets/images/saas/cta.jpg')] bg-no-repeat bg-top bg-cover jarallax"
                    data-jarallax
                    data-speed="0.5"
                  ></div>
                </div>
                <div className="md:col-span-6">
                  <div className="p-6">
                    ...
                    <p className="text-slate-400 max-w-xl">
                      ...
                      others think. As a guest to our forum you are only able to
                      view posts. When you register with the Forumix forum you
                      can join in with topics, start new topics and generally be
                      a part of the first level of our community.
                    </p>

                    <div className="mt-6">
                      <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded me-2 mt-2">
                        Register Now!
                      </Link>
                    </div>
                  </div>
              ...
              <div className="relative overflow-x-auto block w-full bg-white dark:bg-slate-900 rounded-md border border-gray-100 dark:border-slate-800">
                <table className="w-full text-start">
                  <thead className="text-lg border-b border-gray-100 dark:border-slate-800">
                    <tr>
                      <th className="text-start py-6 px-4 font-semibold min-w-[300px]">
                        Forum
                      </th>
                      ...
                      <th className="text-end py-6 px-4 font-semibold min-w-[220px]">
                        Posted
                      </th>
                    </tr>
                  </thead>
                        ...
                        >
                          ...
                          <td className="p-4">
                            <div className="flex items-center">
                              <img
                                src={item.image}
                                className="h-10 rounded-full shadow dark:shadow-slate-800"
                                alt=""
                              />
                              ...
                              <div className="ms-2">
                                ...
                                <p className="text-slate-400 text-sm font-normal inline-flex items-center">
                                  <GoClock /> May 2022
                                </p>
                              </div>
                            </div>
            ...
            <div className="lg:col-span-4 md:col-span-6">
              <div className="sticky top-20">
                ...
                <div className="flex items-center mt-8">
                  ...
                  <div className="ms-3">
                    <Link className="font-semibold hover:text-indigo-600">
                      Consultant Business
                    </Link>
                ...
                <ul className="list-none text-center mt-8 space-x-1">
                  ...
                  <li className="inline">
                    <Link
                      ...
                      className="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-indigo-600 hover:text-white hover:bg-indigo-600"
                    >
                      <Icon.Gitlab className="size-4"></Icon.Gitlab>
                    </Link>
                  </li>
                </ul>
