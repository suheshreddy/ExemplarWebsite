...
export default function IndexYoga() {
  ...
  let handleMovePrev = () => {
    setCurrentImageIndex(
      (prevIndex) => (prevIndex + yogaImage.length - 1) % yogaImage.length
    );
  };
          ...
          <div className="grid grid-cols-1 mt-24">
            <div className="text-center">
              <Link
                ...
                data-type="youtube"
                data-id="S_CGed6E610"
                className="lightbox size-24 rounded-full inline-flex items-center justify-center bg-white/10 hover:bg-white/40 text-white dark:bg-slate-900/10 dark:hover:bg-slate-900/40 transition-all duration-500"
              >
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-5">
                <h3 className="mb-6 md:text-4xl md:leading-normal text-3xl leading-normal font-semibold">
                  The Exemplar Info Yoga <br /> & Meditation
                </h3>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 pb-8 items-center">
            <div className="md:col-span-6">
              <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                Most Popular Meditation Therapy
              </h3>
            </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute md:bottom-1/2 md:translate-y-1/2 md:-end-10 ltr:md:translate-x-0 rtl:md:translate-x-0 -bottom-10 end-1/2 ltr:translate-x-1/2 rtl:-translate-x-1/2 text-center">
                    <Link
                      ...
                      data-type="youtube"
                      data-id="S_CGed6E610"
                      className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-700 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white"
                    >
                ...
                <div>
                  <div className="text-white p-4">
                    <h4 className="leading-normal text-4xl mb-3 font-semibold">
                      Check out some of our <br /> Yoga Poses Videos.
                    </h4>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 text-center">
            <h3 className="mb-4 md:text-4xl text-3xl text-white font-semibold">
              Yoga is the journey of the self <br /> through the self
            </h3>
        ...
        <div className="container relative">
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    <button
                      ...
                      className={`${
                        isOpenTab === 0
                          ...
                          : ''
                      } shadow dark:shadow-gray-800 px-4 py-2 text-center font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out`}
                    >
                      Monday
                    </button>
                  </li>
            ...
            <div className="lg:col-span-8 md:col-span-7">
              <div
                id="myTabContent"
                className="bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md"
              >
                {isOpenTab === 0 ? (
                  <div className="relative overflow-hidden">
                    {yogaTimeTable.map((item, index) => {
                      return (
                        <div
                          key={index}
                          className="md:flex items-center p-6 relative z-1"
                        >
                          <h5 className="text-xl font-semibold w-24">
                            {item.time}
                          </h5>
                          ...
                          <div className="flex items-center md:ms-4 md:mt-0 mt-4">
                            <img
                              src={item.image}
                              className="size-10 rounded-full shadow dark:shadow-gray-800"
                              alt=""
                            />
                    ...
                    <div className="relative inline-block mx-auto size-52 rounded-full overflow-hidden shadow-md dark:shadow-gray-800">
                      ...
                      <ul className="list-none space-x-1 absolute start-0 end-0 -bottom-20 group-hover:bottom-5 transition-all duration-500 ease-in-out flex justify-center">
                        <li>
                          <Link
                            to=""
                            className="size-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full border border-indigo-600 bg-indigo-600 hover:border-indigo-600 hover:bg-indigo-600 text-white"
                          >
                            <svg
        ...
        <div className="grid grid-cols-1 relative">
          ...
          {isOpenLightbox && (
            <Lightbox
              ...
              prevSrc={
                yogaImage[
                  (currentImageIndex + yogaImage.length - 1) % yogaImage.length
                ]
              }
