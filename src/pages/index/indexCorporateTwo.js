          ...
          <div className="relative grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {corporateServices2.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group px-6 py-8 bg-white dark:bg-slate-900 shadow hover:shadow-lg dark:hover:shadow-gray-800 duration-500 ease-in-out border-t-[3px] border-gray-100 dark:border-gray-700 hover:border-indigo-600 dark:hover:border-indigo-600"
                >
              ...
              <div className="">
                ...
                <div className="pt-4 px-3">
                  <h5 className="mb-1 font-semibold text-xl">
                    ...
                    >
                      Exemplar Info Personal Portfolio
                    </Link>
                  </h5>
              ...
              <div className="">
                ...
                <div className="pt-4 px-3">
                  <h5 className="mb-1 font-semibold text-xl">
                    ...
                    >
                      Exemplar Info Minimal Portfolio
                    </Link>
                  </h5>
