  ...
  return (
    <>
      ...
      <section className="relative table w-full py-52 md:py-64 bg-[url('../../assets/images/crypto/bg1.jpg')] bg-center bg-no-repeat bg-cover">
        <div className="container relative">
          <div className="grid grid-cols-1">
            <h5 className="font-normal text-lg text-white/50 mb-3">
              Pay with
              <TypeAnimation
                sequence={[
                  ' Crypto',
            ...
            <p className="text-white/70 max-w-xl mb-0">
              Take full control of your cryptocurrencies and collectibles by
              storing them on your own device.
            </p>
            ...
            <div className="subcribe-form mt-6 mb-4">
              <form className="relative max-w-xl">
                <input
                  ...
                  id="subcribe"
                  name="email"
                  className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none dark:text-white rounded-full bg-white/5 shadow border border-slate-900 text-white"
                ...
                >
                  Register Now <FaArrowRight className="ms-2 text-xs" />
                </button>
              </form>
            </div>
            ...
            <span className="text-white">
              Looking for help?{' '}
              <Link className="text-amber-500">Get in touch with us</Link>
            </span>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-10">
                ...
                <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Buy Cryptocurrency <br /> with Exemplar Info
                </h3>
                <p className="text-slate-400 max-w-xl">
                  You can combine all the Exemplar Info templates into a single
      ...
      <section className="relative md:py-24 py-16 bg-[url('../../assets/images/crypto/bg2.jpg')] bg-center bg-no-repeat bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-medium text-white">
              Our Benefits
            </h3>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {benefitsData.map((item, index) => {
              ...
              return (
                <div
                  className="border border-dashed border-white/30 rounded-md p-6 text-center"
                  key={index}
                >
          ...
          <div className="grid md:grid-cols-12 grid-col-1 items-center gap-[30px]">
            <div className="lg:col-span-5 md:col-span-6 order-2 md:order-1">
              <div className="shadow dark:shadow-gray-800 rounded-md p-6 bg-gray-50 dark:bg-slate-800 overflow-hidden">
                ...
                <h5 className="text-center font-semibold text-2xl mt-3">
                  Exemplar Info Token Sale
                </h5>
                  ...
                  <div className="text-center">
                    <div id="token-sale">
                      <div className="flex">
                        <div
                          id="days"
                          className="md:w-1/4 w-1/2 count-number lg:text-[40px] md:text-[32px] text-[28px] leading-[95px] font-semibold"
                        >
                          {days}
                ...
                <ul className="list-none mt-4">
                  ...
                  <li className="mb-1 flex items-center ms-0">
                    <BsCheckCircle className="text-indigo-600 text-base me-2" />
                    <span className="text-slate-400">Target:</span> &nbsp;900000
                    USD
                  </li>
                </ul>
            ...
            <div className="lg:col-span-7 md:col-span-6 order-1 md:order-2">
              <div className="lg:ms-10">
                ...
                <h4 className="my-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                  The token sale is live!
                </h4>
                <p className="text-slate-400 para-desc mx-auto mb-3">
                  With Exemplar Info Trade, you can be sure your trading skills
                  are matched with excellent service.
                </p>
                <p className="text-slate-400 para-desc mx-auto">
                  Exemplar Info Institutional Markets is a full-stack crypto
                  services platform that works with crypto-native businesses and
                  institutional clients on lending, trading, and custody
                ...
                <div className="mt-4">
                  ...
                  <Link
                    ...
                    data-type="youtube"
                    data-id="S_CGed6E610"
                    className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white m-1 lightbox"
                  >
                    <Icon.Video className="size-4"></Icon.Video>
                  </Link>
                  <span className="font-semibold ms-1 align-middle">
                    Watch Now
                  </span>
                </div>
                <ModalVideo
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 pb-8 text-center">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              With Exemplar Info Trade, you can be sure your trading skills are
          ...
          <div className="grid grid-cols-1 justify-center mt-2">
            <ul className="list-none text-center">
              {cryptotwo.map((item, index) => {
                return (
                  <li className="inline-block md:m-6 my-6 mx-2" key={index}>
                    <img
                      src={item}
                      className="shadow-md dark:shadow-gray-800 rounded-full size-20 p-4"
                      alt=""
                    />
                  </li>
                );
        ...
        <div className="container relative">
          <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1">
            <div className="text-center">
              ...
              <h2 className="mb-0 text-4xl mt-3 font-bold text-indigo-600">
                <CountUp className="counter-value" start={1990} end={2021} />
              </h2>
            </div>
            <div className="text-center">
              <h6 className="text-white mb-0">Team Member</h6>
              <h2 className="mb-0 text-4xl mt-3 font-bold text-indigo-600">
                <CountUp className="counter-value" start={551} end={1000} />+
              </h2>
            </div>
            <div className="text-center">
              <h6 className="text-white mb-0">Users</h6>
              <h2 className="mb-0 text-4xl mt-3 font-bold text-indigo-600">
                <CountUp className="counter-value" start={1} end={10} />M
              </h2>
            </div>
            <div className="text-center">
              <h6 className="text-white mb-0">Insurance Cover</h6>
              <h2 className="mb-0 text-4xl mt-3 font-bold text-indigo-600">
                $<CountUp className="counter-value" start={210} end={410} />M
              </h2>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
            <div className="flex">
              ...
              <div className="flex-1">
                <h5 className="mb-2 text-xl font-semibold">
                  How our <span className="text-indigo-600">Exemplar Info</span>{' '}
                  work ?
                </h5>
            ...
            <div className="flex">
              ...
              <div className="flex-1">
                <h5 className="mb-2 text-xl font-semibold">
                  {' '}
                  Is <span className="text-indigo-600">Exemplar Info</span>{' '}
