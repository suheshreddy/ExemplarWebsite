...
export default function IndexShop() {
  return (
    <>
            ...
            <div className="md:w-1/2 p-3 picture-item">
              <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                ...
                <div className="absolute bottom-4 start-4">
                  <Link className="text-xl font-semibold hover:text-indigo-600 transition-all duration-500">
                    Hoodies
                  </Link>
                </div>
              </div>
        ...
        <div className="container relative mt-16">
          <div className="grid md:grid-cols-12 grid-cols-1 items-center">
            ...
            <div className="lg:col-span-4 md:col-span-6 md:text-end hidden md:block">
              ...
              >
                View More Items <FaArrowRight className="ms-2 text-[10px]" />
              </Link>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 md:hidden mt-8">
            <div className="md:col-span-12 text-center">
              <Link
                ...
                className="relative inline-flex items-center font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:transition-all after:duration-500 text-slate-400 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out"
              >
                View More Items <FaArrowRight className="ms-2 text-xs" />
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-6 md:grid-cols-3 grid-cols-2 mt-8 gap-[30px]">
            {productCategories.map((item, index) => {
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden hover:shadow-lg hover:dark:shadow-gray-800 rounded-md transition-all duration-500 p-6 text-center"
                >
                  <img
                    src={item.image}
                    className="rounded-full shadow-md dark:shadow-gray-800 size-20 block mx-auto mb-2"
                    alt=""
                  />

                  <Link className="font-semibold hover:text-indigo-600 text-lg">
                    {item.title}
                  </Link>
                </div>
              );
      ...
      <section
        className="py-28 w-full table relative bg-[url('../../assets/images/shop/cta.jpg')] bg-center bg-no-repeat bg-cover jarallax"
        data-jarallax
        data-speed="0.5"
      >
              ...
              return (
                <div className="group" key={index}>
                  <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    ...
                    {item.tag ? (
                      <ul className="list-none space-x-1 absolute top-[10px] start-4">
                        <li>
                          <Link
                            className={`${item.tagBg} text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5`}
                          >
