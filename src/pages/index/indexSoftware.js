        ...
        <div className="container relative">
          <div className="grid grid-cols-1 md:mt-36 mt-10 text-center">
            ...
            <div className="subcribe-form mt-6 mb-3">
              <form className="relative max-w-xl mx-auto">
                <input
                  ...
                  id="subcribe"
                  name="email"
                  className="form-input border-0 pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white dark:bg-slate-900 shadow dark:shadow-gray-800"
                  placeholder="Your Email Address :"
                />
                <button
                  type="submit"
                  className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-orange-500 hover:bg-orange-600 border-orange-500 hover:border-orange-600 text-white rounded-full"
                >
                  Try it for free <FaArrowRight className="ms-2 text-[10px]" />
                </button>
              </form>
            </div>
            ...
            <span className="text-slate-400 font-medium">
              Looking for help?{' '}
              <Link className="text-orange-500">Get in touch with us</Link>
            </span>
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px] items-center">
            <div className="p-6">
              <div className="pb-8">
                ...
                <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md w-full">
                  Redeem Now
                </Link>
              </div>
            ...
            <div className="shadow rounded-md p-6 bg-gradient-to-t bg-indigo-600">
              <div className="pb-8">
                ...
                <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-orange-500 hover:bg-orange-600 border-orange-500 hover:border-orange-600 text-white rounded-md w-full">
                  Started Now
                </Link>
              </div>
            ...
            <div className="p-6">
              <div className="pb-8">
                ...
                <Link className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full">
                  Signup Now
                </Link>
              </div>
              <div className="border-b border-slate-200 dark:border-slate-200/5"></div>
