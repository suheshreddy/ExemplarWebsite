    ...
    <>
      ...
      <div className="relative">
        <div className="absolute block w-full h-auto bottom-[25px] z-1 start-0">
          <Link to="#">
            <i className="mdi mdi-arrow-down absolute top-0 start-0 end-0 text-center inline-flex items-center justify-center rounded-full bg-white dark:bg-slate-900 size-12 mx-auto shadow-md dark:shadow-gray-800"></i>
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-6 mt-8">
            ...
            {isImage && (
              <Lightbox
                ...
                nextSrc={
                  portfolioImage[
                    (currentImageIndex + 1) % portfolioImage.length
                  ]
                }
