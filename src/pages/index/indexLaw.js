        ...
        <div className="container relative">
          <div className="grid grid-cols-1 mt-10">
            ...
            <div className="mt-8">
              <Link
                to="#"
                className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white"
              >
                Get Started
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
            <div className="group relative p-6 hover:bg-indigo-600 dark:hover:bg-indigo-600 transition-all duration-500 ease-in-out bg-white dark:bg-slate-900 overflow-hidden text-center">
              ...
              <div className="mt-6">
                ...
                <p className="text-slate-400 group-hover:text-white/75 transition-all duration-500 ease-in-out mt-3">
            ...
            <div className="group relative p-6 bg-indigo-600 dark:hover:bg-indigo-600 transition-all duration-500 ease-in-out overflow-hidden text-center">
              ...
              <div className="mt-6">
                ...
                <p className="text-white/75 transition-all duration-500 ease-in-out mt-3">
                  Competently leverage existing enterprise wide niches through
                  stand alone services. Quickly productize technically.
                </p>
              </div>
            ...
            <div className="lg:col-span-7 md:col-span-6 mt-8 md:mt-0">
              <div className="lg:ms-5">
                <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Welcome to Exemplar Info <br /> Law Firm Company
                </h3>
                ...
                <div className="mt-6">
                  <Link
                    to="/contact-one"
                    className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white me-2 mt-2"
                  >
                      ...
                      <div className="tiny-slide" key={index}>
                        <div className="group relative shadow dark:shadow-gray-800 overflow-hidden mx-2">
                          <div className="relative">
                            <img
                              src={item.iamge}
                              className="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out"
                              alt=""
                            />
                          ...
                          <div className="absolute bottom-6 start-6 end-6">
                            <Link
                              to="#"
                              className="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out"
                            >
                              {item.name}
                            </Link>
        ...
        <div className="container relative">
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
            ...
            <div className="lg:col-span-7 md:order-1 order-2">
              ...
              <ul className="list-none text-slate-400 mt-4">
                <li className="mb- items-center1 flex">
                  <BsCheckCircle className="text-indigo-600 text-base me-2" />{' '}
                  Digital Marketing Solutions for Tomorrow
                </li>
                <li className="mb- items-center1 flex">
