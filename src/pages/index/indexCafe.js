...
export default function IndexCafe() {
  ...
  const handleMovePrev = () => {
    setCurrentImageIndex(
      (prevIndex) => (prevIndex + cafeImage.length - 1) % cafeImage.length
    );
  };
  ...
  return (
    <>
      ...
      <section
        className="relative py-40 md:h-screen flex items-center overflow-hidden"
        id="home"
        style={{
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 mt-10 text-center">
            <div className="md:-rotate-12 -rotate-6">
              <span className="font-cursive-kaushan text-white/70 block mb-2">
                Since 1993
              </span>
              <span className="font-cursive-kaushan text-white font-semibold lg:text-9xl lg:leading-tight md:text-8xl md:leading-tight text-6xl leading-tight block">
              ...
              <div className="mt-8">
                ...
                >
                  Explore More <FaArrowRight className="ms-2 text-[10px]" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="relative md:py-24 py-16">
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-head-ebgaramond font-medium">
              Welcome to Exemplar Info Cafe
            </h3>
            <p className="text-slate-400 max-w-xl mx-auto">
              Every cup is a performance of thoroughly pressured hot water
              through the finest delicious and finely ground compacted coffee.
            </p>
          </div>
            ...
            <div className="lg:col-span-4 md:col-span-6 lg:order-1 order-2">
              <div className="grid grid-cols-1 gap-[30px]">
                {cafeAbout.slice(0, 3).map((item, index) => {
                  return (
                    <div
                      className="group transition-all duration-500 ease-in-out md:text-end text-start"
                      key={index}
                    >
                      <img
                        src={item.image}
                        className="size-16 md:ms-auto p-3 rounded-full shadow-md dark:shadow-gray-800 bg-white"
                        alt=""
                      />
                      <div className="mt-2 md:order-1 order-2">
                        <Link
                          to="#"
                          className="text-xl font-semibold font-head-ebgaramond hover:text-indigo-600"
                        >
                          {item.title}
                        </Link>
                ...
                {cafeAbout.slice(3, 6).map((item, index) => {
                  return (
                    ...
                    >
                      <img
                        src={item.image}
                        className="size-16 p-3 rounded-full shadow-md dark:shadow-gray-800 bg-white"
                        alt=""
                      />
                      <div className="mt-2">
                        <Link
      ...
      <section
        className="relative md:pt-0 pt-48 bg-[url('../../assets/images/cafe/cta.jpg')] bg-center bg-no-repeat bg-cover jarallax bg-fixed"
        data-jarallax
        data-speed="0.5"
      >
        <div className="container relative">
          <div className="md:flex justify-end">
            <div className="md:w-1/2 md:py-36 py-10 lg:px-16 md:px-10 px-6 bg-white dark:bg-slate-900 text-center">
              <img
                src={coffee}
                className="size-16 p-3 rounded-full shadow-md dark:shadow-gray-800 bg-white mx-auto"
                alt=""
              />

              <h4 className="font-head-ebgaramond text-3xl font-medium mt-4">
                Happy Hours
              </h4>

              <p className="text-indigo-600 font-head-ebgaramond text-lg font-medium mt-2">
                Starts at 3pm
              </p>
              ...
              <div className="mt-8">
                <Link
                  to="#"
                  className="py-2.5 px-6 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-lg text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"
                >
                  Book Now
                </Link>
              </div>
            ...
            {cafeData.map((data, index) => {
              return (
                <div className="flex " key={index}>
                  <img
                    src={data.image}
                    className="size-16 rounded-full shadow-md dark:shadow-gray-800"
                    alt=""
                  />
                  ...
                  <div className="ms-3 w-full">
                    <div className="flex justify-between pb-2 border-b border-gray-100 dark:border-gray-800">
                      <Link
                        to="#"
                        className="font-head-ebgaramond hover:text-indigo-600 text-xl font-semibold"
                      >
                        {data.name}
                      </Link>
                  ...
                  {feedback.map((item, index) => (
                    <div className="tiny-slide" key={index}>
                      <div className="text-center">
                        <p className="text-lg text-slate-400 italic font-head-ebgaramond">
                          {item.description}{' '}
                        </p>
                        ...
                        <div className="text-center mt-5">
                          ...
                          <img
                            ...
                            alt=""
                          />
                          <h6 className="mt-2 font-semibold font-head-ebgaramond text-lg">
                            {item.name}
                          </h6>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid md:grid-cols-2 gap-[30px] items-center">
            <div className="">
              <img
                src={ab}
                className="shadow dark:shadow-gray-800 rounded"
                alt=""
              />
            </div>

            <div className="lg:ms-8">
              <h4 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-head-ebgaramond font-medium">
                The Best Quality Coffee <br /> Tastes At One Place
              </h4>
              <p className="text-slate-400 max-w-xl mx-auto">
                Every cup is a performance of thoroughly pressured hot water
                through the finest delicious and finely ground compacted coffee.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
            {cafeBlog.map((item, index) => {
              return (
                <div
                  key={index}
                  className="blog relative rounded shadow dark:shadow-gray-800 overflow-hidden"
                >
                  ...
                  <div className="content p-6">
                    <Link
                      to="/blog-detail"
                      className="title h5 text-xl font-semibold font-head-ebgaramond hover:text-indigo-600 duration-500 ease-in-out"
                    >
                      {item.title}
                    </Link>
                    <p className="text-slate-400 mt-3">{item.desc}</p>
        ...
        <div className="grid grid-cols-1 relative">
          ...
          {lightBox && (
            <Lightbox
              ...
              prevSrc={
                cafeImage[
                  (currentImageIndex + cafeImage.length - 1) % cafeImage.length
                ]
              }
