            ...
            <div className="md:col-span-7">
              <div className="md:me-6">
                <h4 className="font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">
                  Find the perfect <br />{' '}
                  <span className="text-indigo-600">Professional</span> for you
                </h4>
                ...
                <div className="subcribe-form z-1 mt-8">
                  <form className="relative mx-auto max-w-2xl">
                    ...
                    <input
                      ...
                      id="search_name"
                      name="name"
                      className="pt-4 pe-40 pb-4 w-full h-[50px] outline-none text-black dark:text-white rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 ps-12"
                      placeholder="What service are you looking for?"
                    />
                    <button
                      type="submit"
                      className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"
                    >
                      Search
                    </button>
                  </form>
                  <p className="text-slate-400 max-w-xl mt-3">
                    <span className="font-semibold">Popular:</span> House
                    Cleaning, Web Design, Personal Trainers
                  </p>
                </div>
              </div>
            </div>
