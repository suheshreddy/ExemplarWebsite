...
import { FaArrowRight, GoClock } from '../../assets/icons/icons';
    ...
    <>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 items-center mt-10">
            ...
            <p className="text-lg max-w-xl">
              ...
              all Exemplar Info with their fans and unique token collectors!
            </p>
        ...
        <div className="container relative md:mt-24 mt-16">
                  ...
                  <div className="tiny-slide" key={index}>
                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800 hover:shadow-lg dark:hover:shadow-gray-800 duration-500 ease-in-out m-2 mb-5">
                      ...
                      <div className="p-6 pt-0 -mt-10 text-center">
                        ...
                        <div className="mt-4">
                          <Link
                            to={`/nft-creator-profile/${item.id}`}
                            className="text-lg font-semibold hover:text-indigo-600 duration-500 ease-in-out block"
                          >
                            {item.name}
                          </Link>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 md:hidden">
            <div className="md:col-span-12 text-center">
              ...
              >
                See More{' '}
                <FaArrowRight className="ms-2 text-[10px]"></FaArrowRight>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container relative md:mt-24 mt-16">
              ...
              return (
                ...
                >
                  <div className="relative">
                    ...
                    {item.date ? (
                      <div className="absolute bottom-0 start-0 ms-6 mb-6 text-lg ltr:bg-gradient-to-r rtl:bg-gradient-to-l to-indigo-600 from-fuchsia-600 text-white rounded-full px-3 inline-flex items-center">
                        <GoClock className="me-1" />{' '}
                        <small id="auction-item-1" className="font-semibold">
                          {' '}
                          {item.remaining?.days} : {item.remaining?.hours}:{' '}
                          {item.remaining?.minutes}: {item.remaining?.seconds}
                        </small>
                      </div>
                    ) : (
                      ''
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 mt-8">
            <div className="md:col-span-12 text-center">
              ...
              >
                Explore All Items <FaArrowRight className="ms-2 text-[10px]" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="relative md:py-24 py-16 bg-gradient-to-br to-orange-600/30 via-fuchsia-600/30 from-indigo-600/30">
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
              Join the fastest growing Exemplar Info NFTs <br /> with more than
              2000+ NFTs
            </h3>
          ...
          <div className="grid md:grid-cols-2 mt-8 gap-[30px]">
            ...
            <div className="rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 p-6">
              <h5 className="text-2xl font-semibold mb-4">
                Learn more about Exemplar Info
              </h5>
              <p className="text-slate-400 mb-4">
                We are a huge marketplace dedicated to connecting great artists
                of all Exemplar Info.
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {nftCollection.slice(0, 3).map((item, index) => {
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden bg-gray-50 dark:bg-slate-800 rounded-md shadow dark:shadow-gray-800"
                >
                  ...
                  <div className="p-6 pt-0 -mt-10 text-center">
                    ...
                    <div className="mt-4">
                      <Link
                        to="#"
                        className="text-xl leading-none font-semibold hover:text-indigo-600 duration-500 ease-in-out block"
                      >
                        {item.title}
                      </Link>
                    </div>
