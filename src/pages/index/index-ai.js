                  ...
                  <form className="relative max-w-md mx-auto lg:ms-0">
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="support@Exemplar Info.com"
                      />
                    </div>
                    <button
                      type="submit"
                    ...
                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      ...
                      <div className="mt-6">
                        <p className="text-slate-400">
                          ...
                          software that I just don't do at all with Exemplar
                          Info. Suspicious but I can't say I don't love it.
                        </p>
                        <ul className="list-none mb-0 text-amber-400 mt-2">
                          <li className="inline">
                            <i className="mdi mdi-star"></i>
                ...
                <div className="slide h-auto md:w-[360px] w-72 m-2">
                  <ul className="space-y-4">
                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      ...
                      <div className="mt-6">
                        <p className="text-slate-400">
                          The best part about Exemplar Info is every time I pay
                          my employees, my bank balance doesn't go down like it
                    ...
                    <li className="rounded-lg shadow dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      ...
                      <div className="mt-6">
                        <p className="text-slate-400">
                          ...
                          Exemplar Info I somehow don't have to do that anymore.
