            ...
            <div class="container relative md:mt-24 mt-16">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                    {coursesData.map((item,index) =>{
                        return(
                            <div key={index} class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden">
                                <div class="relative overflow-hidden">
                                    ...
                                    <div class="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                                        <div class="pb-4 ps-4 flex items-center">
                                            <img src={item.clientImage} class="size-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt=""/>
                                            <div class="ms-3">
                                                <Link to="" class="font-semibold text-white block">{item.clientName}</Link>
                                                <span class="text-white/70 text-sm">{item.possition}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="content p-6 relative">
                                    <Link to="/course-detail" class="font-medium block text-indigo-600">{item.name}</Link>
                                    <Link to="/course-detail" class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">{item.title}</Link>
                                    ...
                                    <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
                                        <li class="flex items-center me-4">
                                            <LuBookOpen class="text-lg leading-none me-2 text-slate-900 dark:text-white"/>
                                            <span>{item.lectures}</span>
                                        </li>

                                        <li class="flex items-center me-4">
                                            <FiClock class="text-lg leading-none me-2 text-slate-900 dark:text-white"/>
                                            <span>{item.time}</span>
                                        </li>

                                        <li class="flex items-center">
                                            <FiEye class="text-lg leading-none me-2 text-slate-900 dark:text-white"/>
                                            <span>{item.view}</span>
                                        </li>
                                    </ul>
        ...
        <section class="py-20 w-full table relative bg-[url('../../assets/images/coach/cta.jpg')] bg-top bg-no-repeat bg-cover">
            ...
            <div class="container relative">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <div class="mt-8">
                        <Link to="" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">JOIN FOR FREE</Link>
                    </div>
                </div>
            </div>
        </section>
