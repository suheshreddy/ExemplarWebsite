        ...
        <div className="container relative z-3">
          <div className="grid grid-cols-1 mt-10">
            <div className="md:text-start text-center">
              <span className="bg-indigo-600 inline-block text-white text-sm font-semibold px-2.5 rounded mb-4">
                Life Coach
              </span>
              <h1 className="font-bold text-white lg:leading-normal leading-normal text-4xl lg:text-5xl mb-6">
                Unleash Your Real <br /> Potential and Live <br /> Limitless!
              </h1>
        ...
        <div className="container relative">
          <div className="relative grid md:grid-cols-4 grid-cols-1 items-center gap-[30px]">
            <div className="counter-box text-center">
              <h1 className="lg:text-5xl text-4xl font-medium mb-2 text-white">
                <CountUp className="counter-value" start={0} end={1548} />+
              </h1>
              <h5 className="counter-head text-white/70 font-semibold">
                Happy Clients
              </h5>
            </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-5">
                ...
                <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                  Unleash Your Real <br /> Potential and <br /> Live Limitless!
                </h3>
                ...
                <p className="text-slate-400 max-w-xl mt-2">
                  But that to me. Send a distress signal, and inform the Senate
                  that all on board were killed. Dantooine. They’re on
                  Dantooine. The plans you refer to will soon be back in our
                  hands. Alderaan? I’m not going to Alderaan. I got to go home.
                </p>
        ...
        <div class="container relative md:mt-24 mt-16">
              ...
              return (
                ...
                >
                    ...
                    <div class="absolute start-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                      <div class="pb-4 ps-4 flex items-center">
                        <img
                          ...
                          class="size-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto"
                          alt=""
                        />
                        <div class="ms-3">
                          <Link to="" class="font-semibold text-white block">
                            {item.clientName}
                          </Link>
                  ...
                  <div class="content p-6 relative">
                    <Link
                      to="/course-detail"
                      class="font-medium block text-indigo-600"
                    >
                      {item.name}
                    </Link>
                    <Link
                      to="/course-detail"
                      class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2"
                    >
                      {item.title}
                    </Link>
          ...
          <div class="grid md:grid-cols-12 grid-cols-1 mt-8">
            <div class="md:col-span-12 text-center">
              ...
              >
                See All Courses <FiArrowRight class="align-middle ms-1" />
              </Link>
            </div>
          </div>
        </div>
