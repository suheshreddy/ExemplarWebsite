        ...
        <div className="container relative">
          <div className="grid grid-cols-2 md:grid-cols-4">
            <div className="counter-box relative text-center">
              <h3 className="font-extrabold lg:text-[72px] text-[50px] text-white opacity-10">
                <CountUp className="counter-value" end={3452} start={3000} />+
              </h3>
              <span className="counter-head font-semibold text-xl text-white absolute top-2/4 start-0 end-0">
                Investment Projects
              </span>
            </div>
            ...
            <div className="counter-box relative text-center">
              <h3 className="font-extrabold lg:text-[72px] text-[50px] text-white opacity-10">
                <CountUp className="counter-value" end={54} start={5} />
              </h3>
              <span className="counter-head font-semibold text-xl text-white absolute top-2/4 start-0 end-0">
            ...
            <div className="counter-box relative text-center">
              <h3 className="font-extrabold lg:text-[72px] text-[50px] text-white opacity-10">
                <CountUp className="counter-value" end={247} start={12} />+
              </h3>
              <span className="counter-head font-semibold text-xl text-white absolute top-2/4 start-0 end-0">
                Successful Cases
              </span>
            ...
            <div className="lg:col-span-8 md:col-span-12">
              <div className="grid grid-cols-1 pb-8">
                <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                  Instant Smart Solutions <br /> With Exemplar Info
                </h3>
            ...
            <div className="md:col-span-6">
              <div className="lg:ms-5">
                ...
                <p className="text-slate-400 max-w-xl mb-6">
                  ...
                  commodo consequat. Dys aute irure.
                </p>
