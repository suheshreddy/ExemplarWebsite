        ...
        <div className="container relative">
          <div className="grid grid-cols-1 items-center mt-10">
            <span className="text-white/80 font-semibold mb-4 text-lg">
              Turn Your Skills And Expertise Into A Successful Business
            </span>
            <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-white">
              Grow your business <br /> with focus & clarity.
            </h4>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-4">
                      ...
                      >
                        ...
                        <FaArrowRight className="ms-2 text-[10px] inline" />
                      </Link>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-7 md:col-span-6">
              <div className="lg:ms-5">
                ...
                <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Business and technology <br /> consulting for growth
                </h3>
                ...
                <div className="mt-6">
                  <Link
                    to="/contact-one"
                    className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-2"
                  >
                    <FiAirplay className="me-1" /> Get Started
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1">
            {consultingAbout.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group px-6 py-8 hover:bg-white dark:hover:bg-slate-900 hover:shadow dark:hover:shadow-gray-800 duration-500 ease-in-out border-b-[3px] border-transparent hover:border-indigo-600"
                >
