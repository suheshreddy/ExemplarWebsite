    ...
    <>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 mt-10">
            <h4 className="lg:leading-normal leading-normal text-white text-4xl lg:text-5xl mb-5 font-bold">
              Find Your <br /> Favorite Place Here!
            </h4>
                      ...
                      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6 lg:divide-x-[1px] lg:divide-gray-200 lg:dark:divide-gray-700">
                        <div className="filter-search-form relative">
                          ...
                          <input
                            ...
                            type="text"
                            id="location"
                            className="form-input lg:rounded-t-sm lg:rounded-e-none lg:rounded-b-none lg:rounded-s-sm lg:outline-0 w-full filter-input-box bg-gray-50 dark:bg-slate-800 border-0 focus:ring-0"
                        ...
                        <div className="filter-search-form relative">
                          ...
                          <input
                            ...
                            type="text"
                            id="job-keyword"
                            className="form-input lg:rounded-t-sm lg:rounded-e-none lg:rounded-b-none lg:rounded-s-sm lg:outline-0 w-full filter-input-box bg-gray-50 dark:bg-slate-800 border-0 focus:ring-0 start"
                        ...
                        <input
                          ...
                          name="search"
                          style={{ height: '60px' }}
                          className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white searchbtn lg:rounded-t-none lg:rounded-e-sm lg:rounded-b-sm lg:rounded-s-none rounded-lg w-100"
                          value="Search"
                        />
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1">
            <div className="p-6 border-t border-dashed border-white/30">
              <div className="grid md:grid-cols-4 grid-cols-2 gap-[30px]">
                ...
                <div className="counter-box flex items-center justify-center">
                  <h1 className="text-4xl font-bold text-white">
                    <CountUp className="counter-value" start={1} end={15} />
                  </h1>
                  <h5 className="counter-head text-xs font-semibold text-white/40 ms-2">
                ...
                <div className="counter-box flex items-center justify-center">
                  <h1 className="text-4xl font-bold text-white">
                    <CountUp className="counter-value" start={1} end={4} />
                    k+
                  </h1>
                  <h5 className="counter-head text-xs font-semibold text-white/40 ms-2">
                ...
                <div className="counter-box flex items-center justify-center">
                  <h1 className="text-4xl font-bold text-white">
                    <CountUp className="counter-value" start={1} end={4.9} />
                  </h1>
                  <h5 className="counter-head text-xs font-semibold text-white/40 ms-2">
                    Reviews or <br /> Ratings
                  </h5>
                </div>
              </div>
            </div>
      ...
      <section className="relative md:py-24 py-16">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {travelBenefit.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group p-6 rounded-lg shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 hover:-translate-y-2 duration-500"
                >
                  <div className="size-16 bg-indigo-600/5 group-hover:bg-indigo-600 group-hover:text-white border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 duration-500">
                    <Icons />
                  </div>
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="filters-group-wrap mt-4">
              <div className="filters-group">
                <ul className="mb-0 list-none container-filter-border-bottom filter-options space-x-3">
                  ...
                  <li
                    className={`${
                      selectedCategory === 'beach' ? 'active' : ''
                    } inline-block text-lg font-semibold mb-3 cursor-pointer relative border-b border-transparent text-slate-400 duration-500`}
                    onClick={() => matchCategory('beach')}
                  >
                    Beach
                  </li>
                  <li
                    className={`${
                      selectedCategory === 'park' ? 'active' : ''
                    } inline-block text-lg font-semibold mb-3 cursor-pointer relative border-b border-transparent text-slate-400 duration-500`}
                    onClick={() => matchCategory('park')}
                  >
                    Park
                  </li>
                  <li
                    ...
                    onClick={() => matchCategory('nature')}
                  >
                    Nature
                  </li>
                  <li
                    className={`${
                      selectedCategory === 'mountain' ? 'active' : ''
                    } inline-block text-lg font-semibold mb-3 cursor-pointer relative border-b border-transparent text-slate-400 duration-500`}
                    onClick={() => matchCategory('mountain')}
                  >
                    Mountain
                  </li>
                </ul>
          ...
          <div
            id="grid"
            className=" justify-center mx-auto grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px] "
          >
