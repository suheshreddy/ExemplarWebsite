...
export default function IndexGym() {
  ...
  const handleMovePrev = () => {
    setCurrentImageIndex(
      (prevIndex) => (prevIndex + gymImage.length - 1) % gymImage.length
    );
  };
    ...
    <>
          ...
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <div className="mt-8">
              <Link
                ...
                data-type="youtube"
                data-id="S_CGed6E610"
                className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full lightbox p-1 ps-4"
              >
                3:07 Min video{' '}
                <span className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-full ms-2">
      ...
      <section className="relative md:py-24 py-16">
            ...
            <div className="relative z-2 transition-all duration-500 ease-in-out sm:-mt-[200px] -mt-[140px] m-0">
              <div className="grid md:grid-cols-3 grid-cols-1 gap-[24px]">
                {gymAbout.map((item, index) => {
                  return (
                    <div
                      className="group relative overflow-hidden p-6 rounded-lg shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center transition-all duration-500 ease-in-out border-t-8 border-indigo-600/50"
                      key={index}
                    >
                      <img
                        src={item.image1}
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            <div className="md:col-span-5">
              <div className="relative">
                ...
                <div className="absolute bottom-16 end-0">
                  <img
                    src={about02}
                    className="rounded-md shadow-md size-48"
                    alt=""
                  />
                  <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                    <Link
                      ...
                      data-type="youtube"
                      data-id="S_CGed6E610"
                      className="lightbox size-14 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white"
                    >
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                <h5 className="font-semibold text-base text-indigo-600 mb-2">
                  Gym & Fitness
                </h5>
                <h4 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Introducing Exemplar Info, <br /> A Fitness Center
                </h4>
                ...
                <div className="mt-6">
                  ...
                  >
                    Read More <MdKeyboardArrowRight className="text-xl ms-1" />
                  </Link>
                </div>
              </div>
            </div>
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="filters-group-wrap text-center">
              <div className="filters-group">
                <ul className="mb-0 list-none container-filter filter-options">
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'all' ? 'active' : ''
                    }`}
                    data-group="all"
                    onClick={(e) => filterItems(e, 'all')}
                  >
                    All
                  </li>
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'monday' ? 'active' : ''
                    }`}
                    data-group="monday"
                    onClick={(e) => filterItems(e, 'monday')}
                  >
                    Monday
                  </li>
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'tuesday' ? 'active' : ''
                    }`}
                    data-group="tuesday"
                    onClick={(e) => filterItems(e, 'tuesday')}
                  >
                    Tuesday
                  </li>
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'wednesday' ? 'active' : ''
                    }`}
                    data-group="wednesday"
                    onClick={(e) => filterItems(e, 'wednesday')}
                  >
                    Wednesday
                  </li>
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'thursday' ? 'active' : ''
                    }`}
                    data-group="thursday"
                    onClick={(e) => filterItems(e, 'thursday')}
                  >
                    Thursday
                  </li>
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'friday' ? 'active' : ''
                    }`}
                    data-group="friday"
                    onClick={(e) => filterItems(e, 'friday')}
                  >
                    Friday
                  </li>
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${
                      selectedGroup === 'saturday' ? 'active' : ''
                    }`}
                    data-group="saturday"
                    onClick={(e) => filterItems(e, 'saturday')}
                  >
                    Saturday
                  </li>
                </ul>
          ...
          <div
            id="grid"
            className="grid lg:grid-cols-6 md:grid-cols-2 sm:grid-cols-2 grid-cols-2 mt-2 gap-[27px]"
          >
            {exersiceData.map((data, index) => {
              return (
                <div
                  className="picture-item-gym p-2"
        ...
        <div className="container relative md:mt-24 mt-16">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            {gymTeam.map((item, index) => {
              return (
                <div
                  className="group relative rounded-md overflow-hidden shadow text-center"
                  key={index}
                >
                  ...
                  <div className="content absolute bottom-0 group-hover:bottom-6 start-0 end-0 transition-all duration-500 opacity-0 group-hover:opacity-100">
                    ...
                    <p className="text-white/50 relative -bottom-5 group-hover:bottom-0 transition-all duration-500">
                      {item.title}
                    </p>
                    ...
                    <ul className="list-none relative -bottom-12 group-hover:bottom-0 transition-all duration-500 mt-4 flex justify-center space-x-1">
                      <li>
                        <Link
                          to="#"
                          className="size-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center border text-white rounded-md border-indigo-600 bg-indigo-600"
                        >
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 text-center">
            <h3 className="mb-4 md:text-3xl text-2xl text-white font-medium">
              Get Membership for Speak Fitness
            </h3>
            ...
            <Link
              ...
              data-type="youtube"
              data-id="S_CGed6E610"
              className="lightbox size-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10"
            >
