          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="lg:col-span-8 md:col-span-7 md:order-1 order-2">
              <div className="md:me-6">
                ...
                <p className="text-slate-900 dark:text-white/75 text-lg max-w-xl">
                ...
                <div className="grid lg:grid-cols-12 grid-cols-1">
                  <div className="lg:col-span-4 order-1 lg:order-2 bg-indigo-600">
                    <div className="p-[30px] lg:text-start text-center">
                      ...
                      <h4 className="text-2xl font-semibold text-white my-3">
                  ...
                  <div className="lg:col-span-8 order-2 lg:order-1">
                    <div className="grid md:grid-cols-2 grid-cols-1 p-[30px] gap-[30px]">
                      {constructionAbout.map((item, index) => {
                        ...
                        return (
                          <div
                            className="group flex transition-all duration-500 ease-in-out"
                            key={index}
                          >
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div className="absolute bottom-16 end-0">
                  ...
                  <div className="absolute bottom-0 end-0 text-center">
                    <Link
                      ...
                      onClick={() => setOpen(true)}
                      data-id="S_CGed6E610"
                      className="lightbox size-14 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-indigo-600 text-white"
                    >
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                ...
                <h4 className="mb-6 mt-4 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  World's largest and <br /> trusted construction company
                </h4>
                  ...
                  <div className="content pt-3">
                    <h5 className="mb-1">
                      <Link
                        ...
                        className="hover:text-indigo-600 transition-all duration-500 font-semibold text-lg"
                      >
                        {item.title}
                      </Link>
                    </h5>
      ...
      <section className="py-20 w-full table relative bg-[url('../../assets/images/construction/bg2.jpg')] bg-center bg-no-repeat bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 text-center">
            <h3 className="mb-4 md:text-3xl text-2xl md:leading-normal leading-normal text-white font-medium">
              Generating more value <br /> at every level and building a better
              world for everyone
            </h3>
