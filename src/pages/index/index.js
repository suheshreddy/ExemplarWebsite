            ...
            <div className="md:col-span-7">
              <div className="me-6">
                ...
                <p className="text-slate-400 text-lg max-w-xl">
                  We Accelerate Your Business With Perfection
                </p>
                ...
                <div className="mt-6">
                  ...
                  >
                    <FaRegEnvelope className="me-2 text-sm " /> Learn More
                  </Link>
                  <Link
                    to="/documentation"
                    className="py-2 px-5 inline-flex items-center font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-transparent hover:bg-indigo-600 border-indigo-600 text-indigo-600 hover:text-white rounded-md mt-2"
                  >
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-10">
                ...
                <div className="mt-4">
                  ...
                  >
                    Find Out More <MdKeyboardArrowRight className="text-xl" />
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
                  ...
                  <div className="mt-8">
                    <form>
                      <div className="grid grid-cols-1">
                        ...
                        <div className="">
                          <button className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full">
                            Download
                          </button>
                        </div>
                      </div>
            ...
            <div className="lg:col-span-7 md:order-1 order-2">
              <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                ...
                <span className="text-indigo-600">Exemplar Info.</span>
              </h3>
              <p className="text-slate-400 max-w-xl">
                You can combine all the Exemplar Info templates into a single
                  ...
                  return (
                    <div className="tiny-slide" key={index}>
                      <div className="lg:flex p-6 lg:p-0 relative rounded-md shadow dark:shadow-gray-800 overflow-hidden m-2">
                        <img
                          className="size-24 lg:w-48 lg:h-auto lg:rounded-none rounded-full mx-auto"
                          src={item.image}
                          alt=""
                          width="384"
                          height="512"
