    ...
    <>
              ...
              <div className="md:me-6">
                ...
                <div className="mt-6">
                  <Link
                    ...
                    data-type="youtube"
                    data-id="S_CGed6E610"
                    className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white lightbox"
                  >
                    <Icon.Video className="size-4"></Icon.Video>
                  </Link>
                  <span className="font-semibold ms-2 align-middle">
                    Watch Now
                  </span>
                </div>
              </div>
      ...
      <div className="container relative mb-16 mt-8">
        <div className="grid grid-cols-1 pb-4 text-center">
          <h6 className="text-slate-400 text-lg">
        ...
        <div className="container relative">
          <div className="flex">
            <div className="lg:w-1/3 md:1/2 sm:w-2/3 p-6 rounded-md shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900">
              <h6 className="text-indigo-600 font-semibold mb-2">
                Exemplar Info Digital Agency
              </h6>
              <h4 className="mb-4 md:text-[28px]] text-2xl leading-normal font-bold">
                Leading Digital <br /> Business For{' '}
                <span
                  className="text-indigo-600 typewrite"
                  data-period="2000"
                  data-type='[ "Agency", "Software", "Technology", "Studio", "Webapps" ]'
                >
                  {' '}
              ...
              <p className="text-slate-400 mb-0">
                Certain internet providers exploit the fact that fill text
            ...
            {digitalServices.map((item, index) => {
              ...
              return (
                <div className="text-center md:px-6" key={index}>
                  <div
                    className={`${item.background} size-28  rounded-3xl text-4xl flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 mx-auto`}
                  >
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
            ...
            <div className="lg:col-span-4 md:col-span-6 md:text-end hidden md:block">
              ...
              >
                See More <FaArrowRight className="text-sm ms-1" />
              </Link>
            </div>
          </div>

          <div
            className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-4"
            id="grid"
          >
