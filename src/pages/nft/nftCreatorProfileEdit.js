            ...
            <div className="lg:col-span-9 md:col-span-8">
              ...
              <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                ...
                <div className="flex justify-between pb-4">
                  ...
                  <div className="">
                    <input
                      className="form-checkbox rounded border-gray-200 dark:border-gray-800 text-indigo-600 focus:border-indigo-600/30 focus:ring focus:ring-offset-0 focus:ring-indigo-600/20 focus:ring-opacity-50"
                      type="checkbox"
                      value=""
                      id="noti1"
                    />
