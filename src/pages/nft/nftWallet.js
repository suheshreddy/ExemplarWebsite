          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[30px]">
            {walletData.map((data, index) => {
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800 hover:shadow-lg dark:hover:shadow-gray-800 duration-500 ease-in-out"
                >
                  <div className="py-10 bg-gradient-to-r to-orange-600/70 from-indigo-600/70"></div>
                  <div className="p-6 pt-0 -mt-10 text-center">
                    <img
                      src={data.image}
                      className="size-20 p-4 rounded-full bg-white dark:bg-slate-900 shadow-lg dark:shadow-gray-800 mx-auto"
                      alt=""
                    />
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-slate-400">
                        ...
                        >
                          here <FaArrowRight className="text-xs ms-2" />
                        </Link>
                      </p>
                    </div>
                  </div>
