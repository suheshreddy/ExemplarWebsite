          ...
          <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            <div className="lg:col-span-6 md:col-span-5">
              <div className="sticky top-20">
                <img
                  src={data?.image ? data?.image : item_detail_1}
              ...
              <div className="">
                ...
                <div className="mt-6">
                  <Link
                    ...
                    className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md me-2"
                  >
                          ...
                          <div className="rounded-md shadow dark:shadow-gray-800 p-6">
                            <div className="flex items-center">
                              <div className="relative">
                                <img
                                  src={image4}
                                  className="size-20 rounded-md shadow-md dark:shadow-gray-800"
                                  alt=""
                                />
                  ...
                  <div className="grid grid-cols-1">
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        id="number"
                        type="number"
                        className="form-input w-full text-[15px] py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-full outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-3"
                        placeholder="00.00 ETH"
                      />
                    </div>

                    <div className="mb-4">
                      <label className="font-semibold" htmlFor="number2">
                        Enter Your QTY:
                      </label>
                      <input
                        name="quantity"
