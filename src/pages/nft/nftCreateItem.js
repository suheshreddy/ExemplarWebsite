...
export default function NftCreateItem() {
                  ...
                  <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-6 col-span-12">
                      ...
                      <input
                        name="date"
                        type="text"
                        className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 start"
