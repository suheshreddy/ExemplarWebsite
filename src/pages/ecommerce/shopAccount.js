                ...
                >
                  ...
                  <li role="presentation">
                    <button
                      ...
                      aria-selected="false"
                    >
                      <HiOutlineListBullet className="text-[20px] me-2 align-middle" />
                      Orders
                    </button>
                  </li>
                  <li role="presentation">
                    <button
                      ...
                      aria-selected="false"
                    >
                      <BsArrowDownCircle className="text-[18px] me-2 align-middle" />
                      Download
                    </button>
                  </li>
                  <li role="presentation">
                    <button
                      ...
                      aria-selected="false"
                    >
                      <RiMapPinLine className="text-[20px] me-2 align-middle" />
                      Addresses
                    </button>
                  </li>
                  <li role="presentation">
                ...
                {isOpenTab === 0 ? (
                  ...
                  >
                    <p className="text-slate-400 font-semibold">
                      ...
                      ? <Link className="text-red-600">Log out</Link>)
                    </p>

                    <p className="text-slate-400 font-semibold mt-4">
                      From your account dashboard you can view your{' '}
                      <Link className="text-red-600">recent orders</Link>,
                      manage your{' '}
                      ...
                      <table className="w-full text-start text-slate-500 dark:text-slate-400">
                        ...
                        <tbody>
                          <tr className="bg-white dark:bg-slate-900 text-start">
                            ...
                            <td className="px-2 py-3 text-start">
                              It is said that song composers of the past used
                              dummy texts as lyrics when writing melodies in
