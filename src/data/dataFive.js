...
export const meditationData = [
  {
    image: sound,
    title: 'Sound Therapy',
    desc: 'Start working with Exemplar Info that can provide everything you need to generate awareness, drive traffic, connect.',
