...
export const communityData = [
  {
    ...
    title2: 'student',
    des2: "There are so many things I had to do with my old software that I just don't do at all with Exemplar Info. Suspicious but I can't say I don't love it.",
  },
  {
    image: client2,
    name: 'Carl Oliver',
    title: 'student',
    des: "The best part about Exemplar Info is every time I pay my employees, my bank balance doesn't go down like it used to. Looking forward to spending this extra cash when I figure out why my card is being declined.",
    image2: client4,
    name2: 'Jill Webb',
    title2: 'student',
  ...
  },
  {
    ...
    title: 'student',
    des: "I used to have to remit tax to the EU and with Exemplar Info I somehow don't have to do that anymore. Nervous to travel there now though.",
    image2: client6,
    name2: 'Janisha Dall',
    title2: 'student',
...
export const portfolioData = [
  {
    image: pro1,
    title: 'Exemplar Info Personal Portfolio',
    name: 'Creative',
  },
  {
    image: pro2,
    title: 'Exemplar Info Minimal Portfolio',
    name: 'Minimal',
  },
  {
    image: pro3,
    title: 'Exemplar Info NFT Market',
    name: 'Crypto',
  },
  {
    image: pro4,
    title: 'Exemplar Info Portfolio',
    name: 'Portfolio',
  },
  {
    image: pro5,
    title: 'Exemplar Info Constuction',
    name: 'Corporate',
  },
  {
    image: pro6,
    title: 'Exemplar Info SEO',
    name: 'SEO',
  },
];
...
export const forumData = [
  {
    image: client1,
    title: 'Exemplar Info Announcements',
    name: 'Calvin Carlo',
  ...
  },
  {
    image: client3,
    title:
      'Exemplar Info includes the ability to create a better of sites by using the multisite feature.',
    name: 'Tara Arrington',
    desc: 'This forum is for our announcements. Only our staff can create new topics.',
  },
];

export const furnitureImage = [
  insta_1,
  insta_2,
  insta_3,
  insta_4,
