    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<BlogBlockquotePost />}
        />
        <Route exact path="/blog-audio-post" element={<BlogAudioPost />} />

        <Route exact path="/careers" element={<PageJobCareer />} />
        <Route exact path="/about-us" element={<PageAboutus />} />
      </Routes>
    </BrowserRouter>
  );
}
